...
#define UNROLLED_END(bit_start)                                                \
  ...
  CODE_FORCE_INLINE uint8_t ReadByte() {
...
class BaseWriteStream : public ValueObject {
 public:
  ...
  CODE_FORCE_INLINE intptr_t bytes_written() const { return Position(); }
  ...
  CODE_FORCE_INLINE void WriteByte(uint8_t value) {
    EnsureSpace(1);
    *current_++ = value;
  }
 ...
 protected:
  ...
  CODE_FORCE_INLINE intptr_t Remaining() const {
...
class NonStreamingWriteStream : public BaseWriteStream {
 ...
 public:
  ...
  CODE_FORCE_INLINE void SetPosition(intptr_t value) {
...
class StreamingWriteStream : public BaseWriteStream {
 ...
 private:
  ...
  const CODE_StreamingWriteCallback callback_;
