...
#define DEFINE_TOKEN_SYMBOL_INDEX(t, s, p, a) t##Id,
    CODE_TOKEN_LIST(DEFINE_TOKEN_SYMBOL_INDEX) CODE_KEYWORD_LIST(
...
#define DEFINE_SYMBOL_HANDLE_ACCESSOR(t, s, p, a)                              \
  ...
  CODE_TOKEN_LIST(DEFINE_SYMBOL_HANDLE_ACCESSOR)
  CODE_KEYWORD_LIST(DEFINE_SYMBOL_HANDLE_ACCESSOR)
#undef DEFINE_SYMBOL_HANDLE_ACCESSOR
