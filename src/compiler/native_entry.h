...
class NativeEntry : public AllStatic {
 public:
  ...
  static void BootstrapNativeCallWrapper(CODE_NativeArguments args,
                                         CODE_NativeFunction func);

  static uword NoScopeNativeCallWrapperEntry();
  static void NoScopeNativeCallWrapper(CODE_NativeArguments args,
                                       CODE_NativeFunction func);

  static uword AutoScopeNativeCallWrapperEntry();
  static void AutoScopeNativeCallWrapper(CODE_NativeArguments args,
                                         CODE_NativeFunction func);

  static uword LinkNativeCallEntry();
  static void LinkNativeCall(CODE_NativeArguments args);

 private:
  static void NoScopeNativeCallWrapperNoStackCheck(CODE_NativeArguments args,
                                                   CODE_NativeFunction func);
  static void AutoScopeNativeCallWrapperNoStackCheck(CODE_NativeArguments args,
                                                     CODE_NativeFunction func);
