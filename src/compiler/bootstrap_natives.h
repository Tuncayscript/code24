...
#define BOOTSTRAP_FFI_NATIVE_LIST(V)                                           \
  V(FinalizerEntry_SetExternalSize, void, (CODE_Handle, intptr_t))             \
  V(Pointer_asTypedListFinalizerAllocateData, void*, ())                       \
  V(Pointer_asTypedListFinalizerCallbackPointer, void*, ())

class BootstrapNatives : public AllStatic {
 public:
  static CODE_NativeFunction Lookup(CODE_Handle name,
                                    int argument_count,
  ...
  static const uint8_t* Symbol(CODE_NativeFunction nf);
