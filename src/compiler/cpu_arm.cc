...
#elif defined(CODE_HOST_OS_LINUX) || defined(CODE_HOST_OS_ANDROID)
#include <asm/hwcap.h>
#include <sys/auxv.h>
#endif
#endif
...
#if defined(TARGET_HOST_MISMATCH)
#if defined(CODE_TARGET_OS_ANDROID) || defined(CODE_TARGET_OS_MACOS_IOS)
