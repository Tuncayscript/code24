...
#include "src/code_comments.h"
#include "src/code_entry_kind.h"
...
#include "src/static_type_exactness_state.h"
...
#define BASE_OBJECT_IMPLEMENTATION(object, super)                              \
 public: /* NOLINT */                                                          \
  ...
  CODE_NOINLINE static object& CheckedZoneHandle(Zone* zone, ObjectPtr ptr) {  \
    object* obj =                                                              \
  ...
  CODE_NOINLINE static object& CheckedZoneHandle(ObjectPtr ptr) {              \
...
#define OBJECT_IMPLEMENTATION(object, super)                                   \
 public: /* NOLINT */                                                          \
  CODE_NOINLINE void operator=(object##Ptr value) {                            \
    initializeHandle(this, value);                                             \
  }                                                                            \
  CODE_NOINLINE void operator^=(ObjectPtr value) {                             \
    initializeHandle(this, value);                                             \
...
#undef DEFINE_SHARED_READONLY_HANDLE_GETTER
 ...
 protected:
  ...
  CODE_NOINLINE static Object& HandleImpl(Zone* zone,
                                          ObjectPtr ptr,
  ...
  CODE_NOINLINE static Object& ZoneHandleImpl(Zone* zone,
                                              ObjectPtr ptr,
                                              intptr_t default_cid) {
    Object* obj =
        reinterpret_cast<Object*>(VMHandles::AllocateZoneHandle(zone));
  ...
  CODE_NOINLINE static Object* ReadOnlyHandleImpl(intptr_t cid) {
  ...
  template <typename T>
  CODE_FORCE_INLINE static typename T::ObjectPtrType Allocate(
      Heap::Space space) {
  ...
  template <typename T>
  CODE_FORCE_INLINE static typename T::ObjectPtrType AllocateVariant(
      intptr_t class_id,
      Heap::Space space) {
    return static_cast<typename T::ObjectPtrType>(Allocate(
  ...
  template <typename T>
  CODE_FORCE_INLINE static typename T::ObjectPtrType
...
#undef STORE_NON_POINTER_ILLEGAL_TYPE
 ...
 protected:
  ...
  template <typename T>
  CODE_FORCE_INLINE static uword from_offset() {
  ...
  template <typename T>
  CODE_FORCE_INLINE static uword to_offset(intptr_t length = 0) {
 ...
 private:
  ...
  template <typename T>
  CODE_FORCE_INLINE static void InitializeObject(uword address) {
  ...
  template <typename T>
  CODE_FORCE_INLINE static void InitializeObjectVariant(uword address,
                                                        intptr_t class_id) {
...
#if !defined(PRODUCT) &&                                                       \
    (defined(CODE_PRECOMPILER) || defined(CODE_PRECOMPILED_RUNTIME))
...
class Field : public Object {
 public:
  ...
  CODE_WARN_UNUSED_RESULT ErrorPtr
  InitializeInstance(const Instance& instance) const;
  CODE_WARN_UNUSED_RESULT ErrorPtr InitializeStatic() const;

  // Run initializer only.
  CODE_WARN_UNUSED_RESULT ObjectPtr EvaluateInitializer() const;
...
class Library : public Object {
 public:
  ...
  CODE_NativeEntryResolver native_entry_resolver() const {
    return LoadNonPointer<CODE_NativeEntryResolver, std::memory_order_relaxed>(
        &untag()->native_entry_resolver_);
  }
  void set_native_entry_resolver(CODE_NativeEntryResolver value) const {
    StoreNonPointer<CODE_NativeEntryResolver, CODE_NativeEntryResolver,
                    std::memory_order_relaxed>(&untag()->native_entry_resolver_,
                                               value);
  }
  CODE_NativeEntrySymbol native_entry_symbol_resolver() const {
    return LoadNonPointer<CODE_NativeEntrySymbol, std::memory_order_relaxed>(
        &untag()->native_entry_symbol_resolver_);
  }
  void set_native_entry_symbol_resolver(
      CODE_NativeEntrySymbol native_symbol_resolver) const {
    StoreNonPointer<CODE_NativeEntrySymbol, CODE_NativeEntrySymbol,
                    std::memory_order_relaxed>(
        &untag()->native_entry_symbol_resolver_, native_symbol_resolver);
  }

  // Resolver for FFI native function pointers.
  CODE_FfiNativeResolver ffi_native_resolver() const {
    return LoadNonPointer<CODE_FfiNativeResolver, std::memory_order_relaxed>(
        &untag()->ffi_native_resolver_);
  }
  void set_ffi_native_resolver(CODE_FfiNativeResolver value) const {
    StoreNonPointer<CODE_FfiNativeResolver, CODE_FfiNativeResolver,
  ...
  bool is_CODE_scheme() const {
    return UntaggedLibrary::DartSchemeBit::decode(untag()->flags_);
  }
  void set_is_CODE_scheme(bool value) const {
...
class LoadingUnit : public Object {
 public:
  ...
  // embedder calls CODE_DeferredLoadComplete[Error].
...
class Mint : public Integer {
 public:
  ...
  static constexpr int64_t kMaxValue =
      static_cast<int64_t>(CODE_2PART_UINT64_C(0x7FFFFFFF, FFFFFFFF));
  static constexpr int64_t kMinValue =
      static_cast<int64_t>(CODE_2PART_UINT64_C(0x80000000, 00000000));
...
class ReceivePort : public Instance {
 public:
  ...
  CODE_Port Id() const { return send_port()->untag()->id_; }
  ...
  static ReceivePortPtr New(CODE_Port id,
...
class SendPort : public Instance {
 public:
  CODE_Port Id() const { return untag()->id_; }

  CODE_Port origin_id() const { return untag()->origin_id_; }
  void set_origin_id(CODE_Port id) const {
    ASSERT(origin_id() == 0);
  ...
  static SendPortPtr New(CODE_Port id, Heap::Space space = Heap::kNew);
  static SendPortPtr New(CODE_Port id,
                         CODE_Port origin_id,
                         Heap::Space space = Heap::kNew);
