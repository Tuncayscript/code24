...
CODE_FORCE_INLINE static ObjectPtr GetVariableValue(uword addr) {
...
void Debugger::SetExceptionPauseInfo(CODE_ExceptionPauseInfo pause_info) {
...
CODE_ExceptionPauseInfo Debugger::GetExceptionPauseInfo() const {
...
BreakpointLocation* Debugger::BreakpointLocationAtLineCol(
  ...
  bool is_CODE_colon = script_url.StartsWith(Symbols::DartScheme());
  ...
  for (intptr_t i = 0; i < libs.Length(); i++) {
    ...
    bool useResolvedUri = !is_package && !is_CODE_colon;
