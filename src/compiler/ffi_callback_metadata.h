 ...
 public:
  ...
  class Metadata {
   ...
   public:
    ...
    CODE_Port send_port() const {
      ASSERT(IsLive());
      ASSERT(trampoline_type_ == TrampolineType::kAsync);
      return static_cast<CODE_Port>(context_);
    }
...
#if defined(CODE_TARGET_OS_LINUX) && defined(TARGET_ARCH_ARM64)
  static constexpr intptr_t kPageSize = 64 * KB;
#elif defined(CODE_TARGET_OS_ANDROID) && defined(TARGET_ARCH_IS_64_BIT)
  static constexpr intptr_t kPageSize = 64 * KB;
#elif defined(CODE_TARGET_OS_MACOS) && defined(TARGET_ARCH_ARM64)
