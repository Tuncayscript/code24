...
class SnapshotAnalyzer {
 public:
  explicit SnapshotAnalyzer(const CODE_SnapshotAnalyzerInformation& info)
      : info_(info) {}
 ...
 private:
  ...
  const CODE_SnapshotAnalyzerInformation& info_;
  JSONWriter js_;
  Thread* thread_;
  Heap* heap_;
};
...
void CODE_DumpSnapshotInformationAsJson(
    const CODE_SnapshotAnalyzerInformation& info,
    char** out,
    intptr_t* out_len) {
