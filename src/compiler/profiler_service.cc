...
#include "src/protos/perfetto/trace/interned_data/interned_data.pbzero.h"
#include "src/protos/perfetto/trace/profiling/profile_common.pbzero.h"
#include "src/protos/perfetto/trace/profiling/profile_packet.pbzero.h"
...
void Profile::PrintHeaderJSON(JSONObject* obj) {
  ...
  ProfilerCounters counters = Profiler::counters();
  {
    ...
    counts.AddProperty64("stack_walker_CODE_exit",
                         counters.stack_walker_CODE_exit);
...
void Profile::PrintProfilePerfetto(JSONStream* js) {
  ...
  // See "runtime/src/protos/perfetto/trace/interned_data/interned_data.proto"
...
class NoAllocationSampleFilter : public SampleFilter {
 public:
  NoAllocationSampleFilter(CODE_Port port,
...
class AllocationSampleFilter : public SampleFilter {
 public:
  AllocationSampleFilter(CODE_Port port,
                         intptr_t thread_task_mask,
                         int64_t time_origin_micros,
                         int64_t time_extent_micros)
      : SampleFilter(port,
...
class ClassAllocationSampleFilter : public SampleFilter {
 public:
  ClassAllocationSampleFilter(CODE_Port port,
                              const Class& cls,
                              intptr_t thread_task_mask,
                              int64_t time_origin_micros,
                              int64_t time_extent_micros)
