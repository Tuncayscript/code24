...
class Debugger {
 public:
  ...
  void SetExceptionPauseInfo(CODE_ExceptionPauseInfo pause_info);
  CODE_ExceptionPauseInfo GetExceptionPauseInfo() const;
 ...
 private:
  ...
  CODE_ExceptionPauseInfo exc_pause_info_;
