...
#include "src/compiler/aot/aot_call_specializer.h"
#include "src/compiler/aot/precompiler_tracer.h"
#include "src/compiler/assembler/assembler.h"
#include "src/compiler/assembler/disassembler.h"
#include "src/compiler/backend/branch_optimizer.h"
#include "src/compiler/backend/constant_propagator.h"
...
#include "src/compiler/backend/linearscan.h"
#include "src/compiler/backend/range_analysis.h"
#include "src/compiler/backend/redundancy_elimination.h"
#include "src/compiler/backend/type_propagator.h"
#include "src/compiler/cha.h"
...
#include "src/compiler/frontend/flow_graph_builder.h"
...
#include "src/regexp_assembler.h"
#include "src/regexp_parser.h"
...
#if defined(CODE_PRECOMPILER) && !defined(TARGET_ARCH_IA32)
...
#undef DO
      ...
      // canonical by CODE_NewListOfType.
      AddTypeArguments(
...
const char* Precompiler::MustRetainFunction(const Function& function) {
  ...
  //   in CODE_entry.cc or CODE_api_impl.cc.
      ...
      for (intptr_t k = 0; k < members.Length(); k++) {
        ...
        if (function.has_pragma()) {
          ...
          if ((type == EntryPointPragma::kAlways ||
            ...
            // Not `function2`: CODE_GetField will lookup the regular function
...
// Note: not all pseudo-keywords are mentioned in CODE_KEYWORD_LIST
...
#define PREVENT_RENAMING(name, value, priority, attr)                          \
  ...
  CODE_TOKEN_LIST(PREVENT_RENAMING)
  CODE_KEYWORD_LIST(PREVENT_RENAMING)
...
#endif  // defined(CODE_PRECOMPILER) && !defined(TARGET_ARCH_IA32)
