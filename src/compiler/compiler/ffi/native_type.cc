...
#if !defined(CODE_PRECOMPILED_RUNTIME) && !defined(FFI_UNIT_TESTS)
#include "src/compiler/backend/locations.h"
#endif  // !defined(CODE_PRECOMPILED_RUNTIME) && !defined(FFI_UNIT_TESTS)
...
// pkg/src/lib/transformations/ffi_definitions.dart:StructLayout:_calculateLayout.
...
#if (defined(CODE_TARGET_OS_MACOS_IOS) || defined(CODE_TARGET_OS_MACOS)) &&    \
