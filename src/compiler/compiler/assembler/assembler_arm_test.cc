...
ASSEMBLER_TEST_RUN(Simple, test) {
  typedef int (*SimpleCode)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(MoveNegated, test) {
  EXPECT(test != nullptr);
  typedef int (*MoveNegated)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(MoveRotImm, test) {
  EXPECT(test != nullptr);
  typedef int (*MoveRotImm)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(MovImm16, test) {
  EXPECT(test != nullptr);
  typedef int (*MovImm16)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(LoadImmediate, test) {
  EXPECT(test != nullptr);
  typedef int (*LoadImmediate)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(LoadHalfWordUnaligned, test) {
  EXPECT(test != nullptr);
  typedef intptr_t (*LoadHalfWordUnaligned)(intptr_t) CODE_UNUSED;
  uint8_t buffer[4] = {
      0x89,
      0xAB,
      0xCD,
...
ASSEMBLER_TEST_RUN(LoadHalfWordUnsignedUnaligned, test) {
  EXPECT(test != nullptr);
  typedef intptr_t (*LoadHalfWordUnsignedUnaligned)(intptr_t) CODE_UNUSED;
  uint8_t buffer[4] = {
      0x89,
      0xAB,
      0xCD,
...
ASSEMBLER_TEST_RUN(StoreHalfWordUnaligned, test) {
  EXPECT(test != nullptr);
  typedef intptr_t (*StoreHalfWordUnaligned)(intptr_t) CODE_UNUSED;
  uint8_t buffer[4] = {
      0,
      0,
      0,
...
ASSEMBLER_TEST_RUN(LoadWordUnaligned, test) {
  EXPECT(test != nullptr);
  typedef intptr_t (*LoadWordUnaligned)(intptr_t) CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(StoreWordUnaligned, test) {
  EXPECT(test != nullptr);
  typedef intptr_t (*StoreWordUnaligned)(intptr_t) CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(SingleVLoadStore, test) {
  EXPECT(test != nullptr);
  typedef float (*SingleVLoadStore)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(DoubleVLoadStore, test) {
  EXPECT(test != nullptr);
  typedef double (*DoubleVLoadStore)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(SingleFPOperations, test) {
  EXPECT(test != nullptr);
  typedef float (*SingleFPOperations)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(DoubleFPOperations, test) {
  EXPECT(test != nullptr);
  typedef double (*DoubleFPOperations)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(DoubleSqrtNeg, test) {
  EXPECT(test != nullptr);
  typedef int (*DoubleSqrtNeg)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(IntToDoubleConversion, test) {
  EXPECT(test != nullptr);
  typedef double (*IntToDoubleConversionCode)() CODE_UNUSED;
  double res =
...
ASSEMBLER_TEST_RUN(LongToDoubleConversion, test) {
  EXPECT(test != nullptr);
  typedef double (*LongToDoubleConversionCode)() CODE_UNUSED;
  double res =
...
ASSEMBLER_TEST_RUN(IntToFloatConversion, test) {
  EXPECT(test != nullptr);
  typedef float (*IntToFloatConversionCode)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(FloatToIntConversion, test) {
  EXPECT(test != nullptr);
  typedef int (*FloatToIntConversion)(float arg) CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(DoubleToIntConversion, test) {
  typedef int (*DoubleToIntConversion)(double arg) CODE_UNUSED;
  EXPECT(test != nullptr);
...
ASSEMBLER_TEST_RUN(FloatToDoubleConversion, test) {
  typedef double (*FloatToDoubleConversionCode)() CODE_UNUSED;
  EXPECT(test != nullptr);
  double res =
...
ASSEMBLER_TEST_RUN(DoubleToFloatConversion, test) {
  EXPECT(test != nullptr);
  typedef float (*DoubleToFloatConversionCode)() CODE_UNUSED;
  float res =
...
ASSEMBLER_TEST_RUN(FloatCompare, test) {
  EXPECT(test != nullptr);
  typedef int (*FloatCompare)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(DoubleCompare, test) {
  EXPECT(test != nullptr);
  typedef int (*DoubleCompare)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(ForwardBranch, test) {
  EXPECT(test != nullptr);
  typedef int (*ForwardBranch)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(LoadStore, test) {
  EXPECT(test != nullptr);
  typedef int (*LoadStore)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(PushRegisterPair, test) {
  EXPECT(test != nullptr);
  typedef int (*PushRegisterPair)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(PushRegisterPairReversed, test) {
  EXPECT(test != nullptr);
  typedef int (*PushRegisterPairReversed)() CODE_UNUSED;
  EXPECT_EQ(12,
...
ASSEMBLER_TEST_RUN(PopRegisterPair, test) {
  EXPECT(test != nullptr);
  typedef int (*PopRegisterPair)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(PopRegisterPairReversed, test) {
  EXPECT(test != nullptr);
  typedef int (*PopRegisterPairReversed)() CODE_UNUSED;
  EXPECT_EQ(12,
...
ASSEMBLER_TEST_RUN(Semaphore, test) {
  EXPECT(test != nullptr);
  typedef int (*Semaphore)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(FailedSemaphore, test) {
  EXPECT(test != nullptr);
  typedef int (*FailedSemaphore)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(AddSub, test) {
  EXPECT(test != nullptr);
  typedef int (*AddSub)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(AddCarry, test) {
  EXPECT(test != nullptr);
  typedef int (*AddCarry)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(AddCarryInOut, test) {
  EXPECT(test != nullptr);
  typedef int (*AddCarryInOut)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(SubCarry, test) {
  EXPECT(test != nullptr);
  typedef int (*SubCarry)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(SubCarryInOut, test) {
  EXPECT(test != nullptr);
  typedef int (*SubCarryInOut)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Overflow, test) {
  EXPECT(test != nullptr);
  typedef int (*Overflow)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(AndOrr, test) {
  EXPECT(test != nullptr);
  typedef int (*AndOrr)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Multiply, test) {
  EXPECT(test != nullptr);
  typedef int (*Multiply)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Ldrd, test) {
  EXPECT(test != nullptr);
  typedef int64_t (*Tst)(int64_t r0r1, int64_t r2r3) CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Vzipqw, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*Vzipqw)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Vrecpeqs, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*Vrecpeqs)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Vrecpsqs, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*Vrecpsqs)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Reciprocal, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*Reciprocal)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Vrsqrteqs, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*Vrsqrteqs)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Vrsqrtsqs, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*Vrsqrtsqs)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(ReciprocalSqrt, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*ReciprocalSqrt)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(SIMDSqrt, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*SIMDSqrt)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(SIMDSqrt2, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*SIMDSqrt2)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(SIMDDiv, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*SIMDDiv)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Vabsqs, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*Vabsqs)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Vnegqs, test) {
  EXPECT(test != nullptr);
  if (TargetCPUFeatures::neon_supported()) {
    typedef float (*Vnegqs)() CODE_UNUSED;
