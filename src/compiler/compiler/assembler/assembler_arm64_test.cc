...
ASSEMBLER_TEST_RUN(Simple, test) {
  typedef int64_t (*Int64Return)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(LoadStoreDoublePair, test) {
  typedef double (*DoubleReturn)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(Semaphore, test) {
  EXPECT(test != nullptr);
  typedef intptr_t (*Semaphore)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(FailedSemaphore, test) {
  EXPECT(test != nullptr);
  typedef intptr_t (*FailedSemaphore)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(FailedSemaphore32, test) {
  EXPECT(test != nullptr);
  typedef intptr_t (*FailedSemaphore32)() CODE_UNUSED;
  // Lower word has had the failure code (1) added to it.  Upper word is
  // unchanged at 40.
  EXPECT_EQ(41 + (CODE_INT64_C(40) << 32),
...
ASSEMBLER_TEST_RUN(LoadStoreExclusiveR31, test) {
  EXPECT(test != nullptr);
  typedef intptr_t (*LoadStoreExclusiveR31)() CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(AtomicLoadClear, test) {
  typedef intptr_t (*AtomicLoadClear)(intptr_t) CODE_UNUSED;
  intptr_t x = 42;
  EXPECT_EQ(42,
...
ASSEMBLER_TEST_RUN(AtomicLoadSet, test) {
  typedef intptr_t (*AtomicLoadSet)(intptr_t) CODE_UNUSED;
  int64_t x = 42;
  EXPECT_EQ(42,
...
ASSEMBLER_TEST_RUN(LoadAcquireStoreRelease, test) {
  typedef intptr_t (*LoadAcquireStoreRelease)() CODE_UNUSED;
  EXPECT_EQ(0x42,
...
#define SHIFT_32_IMMEDIATE_TEST(macro_op, val, shift, expected)                \
  ...
  ASSEMBLER_TEST_RUN(macro_op##a_##val##_##shift, test) {                      \
    typedef int32_t (*Int32Return)() CODE_UNUSED;                              \
...
ASSEMBLER_TEST_RUN(LoadWordUnaligned, test) {
  EXPECT(test != nullptr);
  typedef int32_t (*LoadWordUnaligned)(intptr_t) CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(AndImmediate32Negative, test) {
  typedef intptr_t (*IntPtrReturn)(intptr_t) CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(StoreReleaseLoadAcquire, test) {
  typedef intptr_t (*StoreReleaseLoadAcquire)(intptr_t) CODE_UNUSED;
...
ASSEMBLER_TEST_RUN(StoreReleaseLoadAcquire1024, test) {
  typedef intptr_t (*StoreReleaseLoadAcquire1024)(intptr_t) CODE_UNUSED;
