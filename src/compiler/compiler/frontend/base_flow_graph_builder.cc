...
#include "src/compiler/backend/range_analysis.h"       // For Range.
#include "src/compiler/frontend/flow_graph_builder.h"  // For InlineExitCollector.
#include "src/compiler/frontend/kernel_translation_helper.h"
#include "src/compiler/jit/compiler.h"  // For Compiler::IsBackgroundCompilation().
