...
#include "src/compiler/backend/il.h"  // For CompileType.
...
class TranslationHelper {
 public:
  ...
  CODE_NORETURN void LookupFailed(NameIndex name);
  CODE_NORETURN void LookupFailed(StringIndex name);
...
class FunctionNodeHelper {
 public:
  ...
  AsyncMarker CODE_async_marker_;
...
class UnboxingInfoMetadata : public ZoneAllocated {
 public:
  // Should match UnboxingKind in pkg/src/lib/metadata/unboxing_info.dart.
  enum UnboxingKind {
    kBoxed,
    kInt,
    kDouble,
