...
#include "src/compiler/backend/flow_graph_compiler.h"
...
#define DEFINE_NULLABLE_TAGGED_NATIVE_CODE_FIELD(ClassName, UnderlyingType,    \
  ...
  case Slot::Kind::k##ClassName##_##FieldName:                                 \
    ...
    NULLABLE_TAGGED_NATIVE_CODE_SLOTS_LIST(
        DEFINE_NULLABLE_TAGGED_NATIVE_CODE_FIELD)

#undef DEFINE_NULLABLE_TAGGED_NATIVE_CODE_FIELD

#define DEFINE_NONNULLABLE_TAGGED_NATIVE_CODE_FIELD(                           \
  ...
  case Slot::Kind::k##ClassName##_##FieldName:                                 \
    ...
    NONNULLABLE_INT_TAGGED_NATIVE_CODE_SLOTS_LIST(
        DEFINE_NONNULLABLE_TAGGED_NATIVE_CODE_FIELD)
    NONNULLABLE_NONINT_TAGGED_NATIVE_CODE_SLOTS_LIST(
        DEFINE_NONNULLABLE_TAGGED_NATIVE_CODE_FIELD)

#undef DEFINE_NONNULLABLE_TAGGED_NATIVE_CODE_FIELD

#define DEFINE_UNBOXED_NATIVE_CODE_FIELD(ClassName, UnderlyingType, FieldName, \
  ...
  case Slot::Kind::k##ClassName##_##FieldName:                                 \
    ...
    UNBOXED_NATIVE_CODE_SLOTS_LIST(DEFINE_UNBOXED_NATIVE_CODE_FIELD)

#undef DEFINE_UNBOXED_NATIVE_CODE_FIELD

#define DEFINE_UNTAGGED_NATIVE_CODE_FIELD(ClassName, UnderlyingType,           \
  ...
  case Slot::Kind::k##ClassName##_##FieldName:                                 \
    ...
    UNTAGGED_NATIVE_CODE_SLOTS_LIST(DEFINE_UNTAGGED_NATIVE_CODE_FIELD)

#undef DEFINE_UNTAGGED_NATIVE_CODE_FIELD

#define DEFINE_NULLABLE_TAGGED_NATIVE_NONCODE_FIELD(ClassName, __, FieldName,  \
                                                    cid, mutability)           \
  case Slot::Kind::k##ClassName##_##FieldName:                                 \
    return new (zone_) Slot(                                                   \
        Slot::Kind::k##ClassName##_##FieldName,                                \
    ...
    NULLABLE_TAGGED_NATIVE_NONCODE_SLOTS_LIST(
        DEFINE_NULLABLE_TAGGED_NATIVE_NONCODE_FIELD)

#undef DEFINE_NULLABLE_TAGGED_NONCODE_FIELD

#define DEFINE_UNBOXED_NATIVE_NONCODE_FIELD(ClassName, __, FieldName,          \
                                            representation, mutability)        \
  case Slot::Kind::k##ClassName##_##FieldName:                                 \
    return new (zone_)                                                         \
        Slot(Slot::Kind::k##ClassName##_##FieldName,                           \
    ...
    UNBOXED_NATIVE_NONCODE_SLOTS_LIST(DEFINE_UNBOXED_NATIVE_NONCODE_FIELD)

#undef DEFINE_UNBOXED_NATIVE_NONCODE_FIELD

#define DEFINE_UNTAGGED_NATIVE_NONCODE_FIELD(ClassName, __, FieldName,         \
  ...
  case Slot::Kind::k##ClassName##_##FieldName:                                 \
    ...
    UNTAGGED_NATIVE_NONCODE_SLOTS_LIST(DEFINE_UNTAGGED_NATIVE_NONCODE_FIELD)

#undef DEFINE_UNTAGGED_NATIVE_NONCODE_FIELD
...
#undef NONTAGGED_NATIVE_CODE_SLOT_CASE
