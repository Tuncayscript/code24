...
#include "src/compiler/backend/block_builder.h"
...
static void NoopNative(CODE_NativeArguments args) {}

static CODE_NativeFunction NoopNativeLookup(CODE_Handle name,
                                            int argument_count,
