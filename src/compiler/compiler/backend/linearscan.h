...
class FlowGraphAllocator : public ValueObject {
 public:
  ...
  CODE_FORCE_INLINE static void SetLifetimePosition(Instruction* instr,
                                                    intptr_t pos) {
    instr->SetPassSpecificId(CompilerPass::kAllocateRegisters, pos);
  }

  CODE_FORCE_INLINE static bool HasLifetimePosition(Instruction* instr) {
    return instr->HasPassSpecificId(CompilerPass::kAllocateRegisters);
  }

  CODE_FORCE_INLINE static intptr_t GetLifetimePosition(
