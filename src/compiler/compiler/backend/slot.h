...
#include "src/compiler/backend/compile_type.h"
...
#define NULLABLE_TAGGED_NATIVE_CODE_SLOTS_LIST(V)                              \
...
//   (i.e. initialized once at construction time and does not change after
//   that) or like a non-final field.
#define NONNULLABLE_INT_TAGGED_NATIVE_CODE_SLOTS_LIST(V)                       \
...
//   (i.e. initialized once at construction time and does not change after
//   that) or like a non-final field.
#define NONNULLABLE_NONINT_TAGGED_NATIVE_CODE_SLOTS_LIST(V)                    \
...
#define UNBOXED_NATIVE_CODE_SLOTS_LIST(V)                                      \
...
// See UNTAGGED_NATIVE_CODE_SLOTS_LIST for the format.
#if defined(CODE_PRECOMPILER) && !defined(TARGET_ARCH_IA32)
#define AOT_ONLY_UNTAGGED_NATIVE_CODE_SLOTS_LIST(V)                            \
...
#define UNTAGGED_NATIVE_CODE_SLOTS_LIST(V)                                     \
  AOT_ONLY_UNTAGGED_NATIVE_CODE_SLOTS_LIST(V)                                  \
...
#define NULLABLE_TAGGED_NATIVE_NONCODE_SLOTS_LIST(V)                           \
...
// Note: Currently LoadFieldInstr::IsImmutableLengthLoad() assumes that no
// slots of non-Dart values represent length loads.
#define UNBOXED_NATIVE_NONCODE_SLOTS_LIST(V)                                   \
...
// load optimizations.
#define UNTAGGED_NATIVE_NONCODE_SLOTS_LIST(V)                                  \
...
#define CHECK_NATIVE_NONCODE_SLOT(__, ___, ____, gc_may_move, _____)           \
  static_assert(!gc_may_move);
UNTAGGED_NATIVE_NONCODE_SLOTS_LIST(CHECK_NATIVE_NONCODE_SLOT)
#undef CHECK_NATIVE_NONCODE_SLOT
...
#define UNBOXED_NATIVE_SLOTS_LIST(V)                                           \
  UNBOXED_NATIVE_CODE_SLOTS_LIST(V)                                            \
  UNBOXED_NATIVE_NONCODE_SLOTS_LIST(V)
...
#define UNTAGGED_NATIVE_SLOTS_LIST(V)                                          \
  UNTAGGED_NATIVE_CODE_SLOTS_LIST(V)                                           \
  UNTAGGED_NATIVE_NONCODE_SLOTS_LIST(V)
...
#define TAGGED_INT_NATIVE_SLOTS_LIST(V)                                        \
  NONNULLABLE_INT_TAGGED_NATIVE_CODE_SLOTS_LIST(V)
...
#define TAGGED_NONINT_NATIVE_SLOTS_LIST(V)                                     \
  NULLABLE_TAGGED_NATIVE_CODE_SLOTS_LIST(V)                                    \
  NONNULLABLE_NONINT_TAGGED_NATIVE_CODE_SLOTS_LIST(V)                          \
  NULLABLE_TAGGED_NATIVE_NONCODE_SLOTS_LIST(V)
...
#define TAGGED_NATIVE_CODE_SLOTS_LIST(V)                                       \
  NULLABLE_TAGGED_NATIVE_CODE_SLOTS_LIST(V)                                    \
  NONNULLABLE_INT_TAGGED_NATIVE_CODE_SLOTS_LIST(V)                             \
  NONNULLABLE_NONINT_TAGGED_NATIVE_CODE_SLOTS_LIST(V)
...
// can only use the following arguments for each entry:
//     V(class_name, _, field_name, _, FINAL|VAR)
#define NOT_TAGGED_NATIVE_CODE_SLOTS_LIST(V)                                   \
  NULLABLE_TAGGED_NATIVE_NONCODE_SLOTS_LIST(V)                                 \
