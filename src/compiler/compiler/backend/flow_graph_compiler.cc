...
#include "src/globals.h"  // Needed here to get TARGET_ARCH_XXX.
...
#include "src/compiler/intrinsifier.h"
...
void FlowGraphCompiler::GenerateTTSCall(const InstructionSource& source,
  ...
  // (see runtime/src/runtime_entry.cc:TypeCheck).  It will use pattern matching
