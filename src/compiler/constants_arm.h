...
// a time.
#if defined(CODE_TARGET_OS_ANDROID) || defined(CODE_TARGET_OS_LINUX)
#define VFPv3_D16
#elif defined(CODE_TARGET_OS_MACOS_IOS) || defined(CODE_TARGET_OS_WINDOWS)
#define VFPv3_D32
#else
#error Which VFP?
#endif
...
const SRegister STMP CODE_USED = EvenSRegisterOf(DTMP);
