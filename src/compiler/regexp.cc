...
#include "src/regexp_assembler_bytecode.h"
#include "src/regexp_ast.h"
#include "src/symbols.h"
#include "src/thread.h"
#include "src/unibrow-inl.h"
...
intptr_t ChoiceNode::CalculatePreloadCharacters(RegExpCompiler* compiler,
  ...
  if (compiler->one_byte()) {
#if !defined(CODE_COMPRESSED_POINTERS) && !defined(TARGET_ARCH_RISCV32)
