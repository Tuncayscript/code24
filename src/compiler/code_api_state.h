...
#ifndef RUNTIME_VM_CODE_API_STATE_H_
#define RUNTIME_VM_CODE_API_STATE_H_
...
// and are destroyed when a CODE_ExitScope() is called.
class LocalHandle {
 public:
  // Accessors.
  ...
  CODE_Handle apiHandle() { return reinterpret_cast<CODE_Handle>(this); }
...
class PersistentHandle {
 public:
  ...
  CODE_PersistentHandle apiHandle() {
    return reinterpret_cast<CODE_PersistentHandle>(this);
  }

  static intptr_t ptr_offset() { return OFFSET_OF(PersistentHandle, ptr_); }

  static PersistentHandle* Cast(CODE_PersistentHandle handle);
...
class FinalizablePersistentHandle {
 public:
  ...
  CODE_HandleFinalizer callback() const { return callback_; }
  CODE_WeakPersistentHandle ApiWeakPersistentHandle() {
    return reinterpret_cast<CODE_WeakPersistentHandle>(this);
  }
  CODE_FinalizableHandle ApiFinalizableHandle() {
    return reinterpret_cast<CODE_FinalizableHandle>(this);
  }
  ...
  static FinalizablePersistentHandle* Cast(CODE_WeakPersistentHandle handle);
  static FinalizablePersistentHandle* Cast(CODE_FinalizableHandle handle);
 ...
 private:
  ...
  void set_callback(CODE_HandleFinalizer callback) { callback_ = callback; }
  ...
  CODE_HandleFinalizer callback_;
  bool auto_delete_;
...
class LocalHandles : Handles<kLocalHandleSizeInWords,
 ...
 public:
  ...
  bool IsValidHandle(CODE_Handle object) const {
...
class PersistentHandles : Handles<kPersistentHandleSizeInWords,
 ...
 public:
  ...
  bool IsValidHandle(CODE_PersistentHandle object) const {
    return IsValidScopedHandle(reinterpret_cast<uword>(object));
  }

  bool IsFreeHandle(CODE_PersistentHandle object) const {
...
class FinalizablePersistentHandles
 ...
 public:
  ...
  // Validate if passed in handle is a Persistent Handle.
  bool IsValidHandle(CODE_WeakPersistentHandle object) const {
    return IsValidScopedHandle(reinterpret_cast<uword>(object));
  }

  bool IsValidHandle(CODE_FinalizableHandle object) const {
    return IsValidScopedHandle(reinterpret_cast<uword>(object));
  }

  bool IsFreeHandle(CODE_WeakPersistentHandle object) const {
...
// Structure used for the implementation of local scopes used in CODE_api.
...
class ApiState {
 public:
  ...
  bool IsValidPersistentHandle(CODE_PersistentHandle object) {
    MutexLocker ml(&mutex_);
    return persistent_handles_.IsValidHandle(object);
  }

  bool IsActivePersistentHandle(CODE_PersistentHandle object) {
    MutexLocker ml(&mutex_);
    return persistent_handles_.IsValidHandle(object) &&
           !persistent_handles_.IsFreeHandle(object);
  }

  bool IsValidWeakPersistentHandle(CODE_WeakPersistentHandle object) {
    MutexLocker ml(&mutex_);
    return weak_persistent_handles_.IsValidHandle(object);
  }

  bool IsValidFinalizableHandle(CODE_FinalizableHandle object) {
    MutexLocker ml(&mutex_);
    return weak_persistent_handles_.IsValidHandle(object);
  }

  bool IsActiveWeakPersistentHandle(CODE_WeakPersistentHandle object) {
    MutexLocker ml(&mutex_);
    return weak_persistent_handles_.IsValidHandle(object) &&
...
#endif  // RUNTIME_VM_CODE_API_STATE_H_
