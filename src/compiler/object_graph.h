...
class CallbackHeapSnapshotWriter : public ChunkedWriter {
 public:
  CallbackHeapSnapshotWriter(Thread* thread,
                             CODE_HeapSnapshotWriteChunkCallback callback,
                             void* context);
 ...
 private:
  CODE_HeapSnapshotWriteChunkCallback callback_;
  void* context_;
};
...
// runtime/src/service/heap_snapshot.md.
...
#endif  // !defined(CODE_ENABLE_HEAP_SNAPSHOT_WRITER)
