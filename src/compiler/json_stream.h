...
#include "include/CODE_api.h"  // for CODE_Port
...
//
//  - runtime/src/service/vmservice.dart
...
class JSONStream : ValueObject {
 public:
  ...
  void set_reply_port(CODE_Port port);
  ...
  CODE_Port reply_port() const { return reply_port_; }
 ...
 private:
  ...
  void PostNullReply(CODE_Port port);
