...
//
// See also |useCompactUnwind| method in LLVM (https://github.com/llsrc/llvm-project/blob/b27430f9f46b88bcd54d992debc8d72e131e1bd0/llsrc/lib/MC/MCObjectFileInfo.cpp#L28-L50)
...
#elif defined(CODE_TARGET_OS_LINUX) || defined(CODE_TARGET_OS_ANDROID) ||      \
    defined(CODE_TARGET_OS_FUCHSIA)
...
#if defined(CODE_TARGET_OS_LINUX) || defined(CODE_TARGET_OS_ANDROID) ||        \
    defined(CODE_TARGET_OS_FUCHSIA)
...
#elif defined(CODE_TARGET_OS_MACOS) || defined(CODE_TARGET_OS_MACOS_IOS)
...
void AssemblyImageWriter::FrameUnwindPrologue() {
  ...
  // See also https://github.com/llsrc/llvm-project/issues/62574 and
