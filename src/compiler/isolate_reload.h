...
class IsolateGroupReloadContext {
 public:
  ...
  static CODE_FileModifiedCallback file_modified_callback() {
    return file_modified_callback_;
  }
  static void SetFileModifiedCallback(CODE_FileModifiedCallback callback) {
 ...
 private:
  ...
  static CODE_FileModifiedCallback file_modified_callback_;
};
