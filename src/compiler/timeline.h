...
#if defined(FUCHSIA_SDK) || defined(CODE_HOST_OS_FUCHSIA)
#include <lib/trace-engine/context.h>
#include <lib/trace-engine/instrumentation.h>
#elif defined(CODE_HOST_OS_MACOS)
#include <os/signpost.h>
#endif  // defined(FUCHSIA_SDK) || defined(CODE_HOST_OS_FUCHSIA)
...
class Timeline : public AllStatic {
 public:
  ...
  static CODE_TimelineRecorderCallback callback() { return callback_; }
  static void set_callback(CODE_TimelineRecorderCallback callback) {
    callback_ = callback;
  }
...
#undef TIMELINE_STREAM_FLAGS
 ...
 private:
  ...
  static CODE_TimelineRecorderCallback callback_;
...
class TimelineEvent {
 public:
  ...
  CODE_Port isolate_id() const { return isolate_id_; }
...
class IsolateTimelineEventFilter : public TimelineEventFilter {
 public:
  explicit IsolateTimelineEventFilter(CODE_Port isolate_id,
...
// CODE_SetTimelineRecorderCallback.
