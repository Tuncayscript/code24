...
#include "src/protos/perfetto/common/builtin_clock.pbzero.h"
#include "src/protos/perfetto/trace/clock_snapshot.pbzero.h"
#include "src/protos/perfetto/trace/trace_packet.pbzero.h"
#include "src/protos/perfetto/trace/track_event/debug_annotation.pbzero.h"
#include "src/protos/perfetto/trace/track_event/process_descriptor.pbzero.h"
#include "src/protos/perfetto/trace/track_event/thread_descriptor.pbzero.h"
#include "src/protos/perfetto/trace/track_event/track_descriptor.pbzero.h"
#include "src/protos/perfetto/trace/track_event/track_event.pbzero.h"
...
CODE_TimelineRecorderCallback Timeline::callback_ = nullptr;
...
void TimelineEventEmbedderCallbackRecorder::OnEvent(TimelineEvent* event) {
  CODE_TimelineRecorderCallback callback = Timeline::callback();
  if (callback == nullptr) {
    return;
  }

  CODE_TimelineRecorderEvent recorder_event;
  recorder_event.version = CODE_TIMELINE_RECORDER_CURRENT_VERSION;
  switch (event->event_type()) {
    case TimelineEvent::kBegin:
      recorder_event.type = CODE_Timeline_Event_Begin;
      break;
    case TimelineEvent::kEnd:
      recorder_event.type = CODE_Timeline_Event_End;
      break;
    case TimelineEvent::kInstant:
      recorder_event.type = CODE_Timeline_Event_Instant;
      break;
    case TimelineEvent::kDuration:
      recorder_event.type = CODE_Timeline_Event_Duration;
      break;
    case TimelineEvent::kAsyncBegin:
      recorder_event.type = CODE_Timeline_Event_Async_Begin;
      break;
    case TimelineEvent::kAsyncEnd:
      recorder_event.type = CODE_Timeline_Event_Async_End;
      break;
    case TimelineEvent::kAsyncInstant:
      recorder_event.type = CODE_Timeline_Event_Async_Instant;
      break;
    case TimelineEvent::kCounter:
      recorder_event.type = CODE_Timeline_Event_Counter;
      break;
    case TimelineEvent::kFlowBegin:
      recorder_event.type = CODE_Timeline_Event_Flow_Begin;
      break;
    case TimelineEvent::kFlowStep:
      recorder_event.type = CODE_Timeline_Event_Flow_Step;
      break;
    case TimelineEvent::kFlowEnd:
      recorder_event.type = CODE_Timeline_Event_Flow_End;
      break;
    default:
      // Type not expressible as CODE_Timeline_Event_Type: drop event.
      return;
  }
  ...
  recorder_event.arguments =
      reinterpret_cast<CODE_TimelineRecorderEvent_Argument*>(
          event->arguments());
