#ifndef RUNTIME_VM_CODE_ENTRY_H_
#define RUNTIME_VM_CODE_ENTRY_H_
...
class DartLibraryCalls : public AllStatic {
 public:
  ...
  static ObjectPtr LookupHandler(CODE_Port port_id);

  // Returns handler on success, an ErrorPtr on failure, null if can't find
  // handler for this port id.
  static ObjectPtr HandleMessage(CODE_Port port_id, const Instance& message);
...
#endif  // RUNTIME_VM_CODE_ENTRY_H_
