...
class HeapProfileSampler {
 public:
  ...
  static CODE_HeapSamplingDeleteCallback delete_callback() {
 ...
 private:
  ...
  static CODE_HeapSamplingCreateCallback create_callback_;
  static CODE_HeapSamplingDeleteCallback delete_callback_;
