...
class Heap {
 public:
  ...
  CODE_PerformanceMode mode() const { return mode_; }
  CODE_PerformanceMode SetMode(CODE_PerformanceMode mode);
...
#if !defined(PRODUCT) || defined(FORCE_INCLUDE_SAMPLING_HEAP_PROFILER)
  void ReportSurvivingAllocations(CODE_HeapSamplingReportCallback callback,
                                  void* context) {
 ...
 private:
  ...
  RelaxedAtomic<CODE_PerformanceMode> mode_ = {CODE_PerformanceMode_Default};
