...
CODE_HeapSamplingCreateCallback HeapProfileSampler::create_callback_ = nullptr;
CODE_HeapSamplingDeleteCallback HeapProfileSampler::delete_callback_ = nullptr;
...
void* HeapProfileSampler::InvokeCallbackForLastSample(intptr_t cid) {
  ...
  void* result = create_callback_(
      reinterpret_cast<CODE_Isolate>(thread_->isolate()),
      reinterpret_cast<CODE_IsolateGroup>(thread_->isolate_group()),
