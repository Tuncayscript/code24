...
class Service : public AllStatic {
 public:
  ...
  static CODE_ServiceStreamListenCallback stream_listen_callback() {
    return stream_listen_callback_;
  }
  static CODE_ServiceStreamCancelCallback stream_cancel_callback() {
  ...
  static bool HasDartLibraryKernelForSources() {
    return (CODE_library_kernel_ != nullptr);
  }

  static const uint8_t* CODE_library_kernel() { return CODE_library_kernel_; }

  static intptr_t CODE_library_kernel_length() {
    return CODE_library_kernel_len_;
  }

 private:
  static ErrorPtr InvokeMethod(Isolate* isolate,
                               const Array& message,
                               bool parameters_are_CODE_objects = false);
  ...
  static CODE_ServiceStreamListenCallback stream_listen_callback_;
  static CODE_ServiceStreamCancelCallback stream_cancel_callback_;
  static CODE_GetVMServiceAssetsArchive get_service_assets_callback_;
  static CODE_EmbedderInformationCallback embedder_information_callback_;

  static void* service_response_size_log_file_;

  static const uint8_t* CODE_library_kernel_;
  static intptr_t CODE_library_kernel_len_;
};
