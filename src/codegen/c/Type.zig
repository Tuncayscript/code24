...
pub const @"function": CType = .{ .index = .void };
pub const @"boolean": CType = .{ .index = .bool };
...
pub const @"integer": CType = .{ .index = .int64_t };
pub const @"uint": CType = .{ .index = .uint64_t };
pub const @"i128": CType = .{ .index = .zig_i128 };
pub const @"u128": CType = .{ .index = .zig_u128 };
pub const @"size": CType = .{ .index = .intptr_t };
