...
/// About:
/// Filename: bindings.zig
/// Author(-s): Tunjay Akbarli (tunjayakbarli@it-gss.com)
/// Date: Tuesday, May 14, 2024

/// NOTE: We do this instead of @cImport because the self-hosted compiler is easier to bootstrap if it does not depend on translate-c.
/// WARNING: Do not compare directly to .True, use toBool() instead.
