...
#define GET_INT16(a)                            \
    ...
    ((((int16_t)a[0])<<0)  |                    \
     (((int16_t)a[1])<<8)))
#define PUT_INT32(a,i) language_store_unaligned_i32((void*)a,
    (uint32_t)bswap_32((int32_t)(i)))
#else
#define GET_INT32(a) (int32_t)language_load_unaligned_i32((void*)a)
#define GET_INT16(a) (int16_t)language_load_unaligned_i16((void*)a)
#define PUT_INT32(a,i) language_store_unaligned_i32((void*)a, (uint32_t)(i))
#endif
...
*/
LANGUAGE_EXTENSION static value_t apply_cl(fl_context_t *fl_ctx, uint32_t nargs)
{
    VM_LABELS;
    VM_APPLY_LABELS;
...
static void lisp_init(fl_context_t *fl_ctx, size_t initial_heapsize)
{
    ...
    fl_ctx->language_sym = symbol(fl_ctx, "language_value");
    fl_ctx->language_char_sym = symbol(fl_ctx, "language_char");
...
extern void fl_init_language_extensions(fl_context_t *fl_ctx);

void fl_init(fl_context_t *fl_ctx, size_t initial_heapsize)
{
    lisp_init(fl_ctx, initial_heapsize);
    fl_init_language_extensions(fl_ctx);
}
