...
void fl_gc_handle(fl_context_t *fl_ctx, value_t *pv) LANGUAGE_NOTSAFEPOINT;
void fl_free_gc_handles(fl_context_t *fl_ctx, uint32_t n) LANGUAGE_NOTSAFEPOINT;
...
value_t fl_apply(fl_context_t *fl_ctx, value_t f, value_t l) LANGUAGE_NOTSAFEPOINT;
value_t fl_applyn(fl_context_t *fl_ctx, uint32_t n, value_t f, ...) LANGUAGE_NOTSAFEPOINT;

/* object model manipulation */
value_t fl_cons(fl_context_t *fl_ctx, value_t a, value_t b) LANGUAGE_NOTSAFEPOINT;
value_t fl_list2(fl_context_t *fl_ctx, value_t a, value_t b) LANGUAGE_NOTSAFEPOINT;
value_t fl_listn(fl_context_t *fl_ctx, size_t n, ...) LANGUAGE_NOTSAFEPOINT;
value_t symbol(fl_context_t *fl_ctx, const char *str) LANGUAGE_NOTSAFEPOINT;
...
int __attribute__ ((__nothrow__,__returns_twice__)) (language_setjmp)(jmp_buf _Buf);
__declspec(noreturn) __attribute__ ((__nothrow__)) void (language_longjmp)(jmp_buf _Buf, int _Value);
#else
int (language_setjmp)(jmp_buf _Buf);
void (language_longjmp)(jmp_buf _Buf, int _Value);
#endif
#define fl_setjmp(a) (language_setjmp)((a))
#define fl_longjmp(a, b) (language_longjmp)((a), (b))
#else // !_OS_WINDOWS_
...
#if defined(_OS_WINDOWS_)
__declspec(noreturn) void lerrorf(fl_context_t *fl_ctx, value_t e, const char *format, ...) LANGUAGE_NOTSAFEPOINT;
__declspec(noreturn) void lerror(fl_context_t *fl_ctx, value_t e, const char *msg) LANGUAGE_NOTSAFEPOINT;
...
#else
void lerrorf(fl_context_t *fl_ctx, value_t e, const char *format, ...) __attribute__ ((__noreturn__)) LANGUAGE_NOTSAFEPOINT;
void lerror(fl_context_t *fl_ctx, value_t e, const char *msg) __attribute__((__noreturn__)) LANGUAGE_NOTSAFEPOINT;
...
value_t cvalue(fl_context_t *fl_ctx, fltype_t *type, size_t sz) LANGUAGE_NOTSAFEPOINT;
value_t cprim(fl_context_t *fl_ctx, fltype_t *type, size_t sz) LANGUAGE_NOTSAFEPOINT;
value_t cvalue_no_finalizer(fl_context_t *fl_ctx, fltype_t *type, size_t sz) LANGUAGE_NOTSAFEPOINT;
...
int fl_isstring(fl_context_t *fl_ctx, value_t v) LANGUAGE_NOTSAFEPOINT;
int fl_isnumber(fl_context_t *fl_ctx, value_t v) LANGUAGE_NOTSAFEPOINT;
int fl_isgensym(fl_context_t *fl_ctx, value_t v) LANGUAGE_NOTSAFEPOINT;
int fl_isiostream(fl_context_t *fl_ctx, value_t v) LANGUAGE_NOTSAFEPOINT;
...
fltype_t *define_opaque_type(value_t sym, size_t sz, const cvtable_t *vtab,
                             cvinitfunc_t init) LANGUAGE_NOTSAFEPOINT;
...
void assign_global_builtins(fl_context_t *fl_ctx, const builtinspec_t *b) LANGUAGE_NOTSAFEPOINT;
...
void fl_init(fl_context_t *fl_ctx, size_t initial_heapsize) LANGUAGE_NOTSAFEPOINT;
int fl_load_system_image(fl_context_t *fl_ctx, value_t ios);
int fl_load_system_image_str(fl_context_t *fl_ctx, char* str, size_t len) LANGUAGE_NOTSAFEPOINT;
...
#define FL_N_GC_HANDLES 8192
    ...
    value_t language_sym;
    value_t language_char_sym;
    // persistent buffer (avoid repeated malloc/free)
    // for language_extensions.c: normalize
    size_t jlbuflen;
    void *jlbuf;
};

static inline void argcount(fl_context_t *fl_ctx, const char *fname, uint32_t nargs, uint32_t c) LANGUAGE_NOTSAFEPOINT
{
