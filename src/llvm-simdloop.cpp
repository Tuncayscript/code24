...
static unsigned getReduceOpcode(Instruction *J, Instruction *operand) LANGUAGE_NOTSAFEPOINT
{
    switch (J->getOpcode()) {
...
static void enableUnsafeAlgebraIfReduction(PHINode *Phi, Loop &L, OptimizationRemarkEmitter &ORE, ScalarEvolution *SE) LANGUAGE_NOTSAFEPOINT
{
...
static bool processLoop(Loop &L, OptimizationRemarkEmitter &ORE, ScalarEvolution *SE) LANGUAGE_NOTSAFEPOINT
{
