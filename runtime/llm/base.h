...
#define LLM_ASSERT _ASSERTE
#define LLM_VERIFY LLM_ASSERT
#define LLM_VERIFY_(result, expression) LLM_ASSERT(result == expression)

#else

#define LLM_ASSERT(expression) ((void)0)
#define LLM_VERIFY(expression) (void)(expression)
#define LLM_VERIFY_(result, expression) (void)(expression)

#endif

#define LLM_IMPL_SHIM(...) (*(abi_t<__VA_ARGS__>**)&static_cast<__VA_ARGS__ const&>(static_cast<D const&>(*this)))

#ifdef __INTELLISENSE__
#define LLM_IMPL_AUTO(...) __VA_ARGS__
#else
#define LLM_IMPL_AUTO(...) auto
#endif
...
#ifdef LLM_IMPL_NUMERICS
#define _WINDOWS_NUMERICS_NAMESPACE_ llm::OS::Foundation::Numerics
#define _WINDOWS_NUMERICS_BEGIN_NAMESPACE_ LLM_EXPORT namespace llm::OS::Foundation::Numerics
...
#if defined(_MSC_VER)
#define LLM_IMPL_NOINLINE __declspec(noinline)
#elif defined(__GNUC__)
#define LLM_IMPL_NOINLINE __attribute__((noinline))
#else
#define LLM_IMPL_NOINLINE
#endif

#ifdef __IUnknown_INTERFACE_DEFINED__
#define LLM_IMPL_IUNKNOWN_DEFINED
#else
...
namespace llm::impl
{
#ifdef LLM_IMPL_IUNKNOWN_DEFINED
...
__declspec(selectany) int32_t(__stdcall* llm_to_hresult_handler)(void* address) noexcept {};
__declspec(selectany) llm::hstring(__stdcall* llm_to_message_handler)(void* address) {};
__declspec(selectany) void(__stdcall* llm_throw_hresult_handler)(uint32_t lineNumber, char const* fileName, char const* functionName, void* returnAddress, llm::hresult const result) noexcept {};
__declspec(selectany) void(__stdcall* llm_suspend_handler)(void const* token) noexcept {};
__declspec(selectany) void(__stdcall* llm_resume_handler)(void const* token) noexcept {};
__declspec(selectany) int32_t(__stdcall* llm_activation_handler)(void* classId, llm::guid const& iid, void** factory) noexcept {};

extern "C"
{
    void* __stdcall LLM_IMPL_LoadLibraryW(wchar_t const* name) noexcept;
    int32_t __stdcall LLM_IMPL_FreeLibrary(void* library) noexcept;
    void* __stdcall LLM_IMPL_GetProcAddress(void* library, char const* name) noexcept;

    int32_t __stdcall LLM_IMPL_SetErrorInfo(uint32_t reserved, void* info) noexcept;
    int32_t __stdcall LLM_IMPL_GetErrorInfo(uint32_t reserved, void** info) noexcept;
    int32_t __stdcall LLM_IMPL_CoInitializeEx(void*, uint32_t type) noexcept;
    void    __stdcall LLM_IMPL_CoUninitialize() noexcept;

    int32_t  __stdcall LLM_IMPL_CoCreateFreeThreadedMarshaler(void* outer, void** marshaler) noexcept;
    int32_t  __stdcall LLM_IMPL_CoCreateInstance(llm::guid const& clsid, void* outer, uint32_t context, llm::guid const& iid, void** object) noexcept;
    int32_t  __stdcall LLM_IMPL_CoGetCallContext(llm::guid const& iid, void** object) noexcept;
    int32_t  __stdcall LLM_IMPL_CoGetObjectContext(llm::guid const& iid, void** object) noexcept;
    int32_t  __stdcall LLM_IMPL_CoGetApartmentType(int32_t* type, int32_t* qualifier) noexcept;
    void*    __stdcall LLM_IMPL_CoTaskMemAlloc(std::size_t size) noexcept;
    void     __stdcall LLM_IMPL_CoTaskMemFree(void* ptr) noexcept;
    llm::impl::bstr __stdcall LLM_IMPL_SysAllocString(wchar_t const* value) noexcept;
    void     __stdcall LLM_IMPL_SysFreeString(llm::impl::bstr string) noexcept;
    uint32_t __stdcall LLM_IMPL_SysStringLen(llm::impl::bstr string) noexcept;
    int32_t  __stdcall LLM_IMPL_IIDFromString(wchar_t const* string, llm::guid* iid) noexcept;
    int32_t  __stdcall LLM_IMPL_MultiByteToWideChar(uint32_t codepage, uint32_t flags, char const* in_string, int32_t in_size, wchar_t* out_string, int32_t out_size) noexcept;
    int32_t  __stdcall LLM_IMPL_WideCharToMultiByte(uint32_t codepage, uint32_t flags, wchar_t const* int_string, int32_t in_size, char* out_string, int32_t out_size, char const* default_char, int32_t* default_used) noexcept;
    void* __stdcall    LLM_IMPL_HeapAlloc(void* heap, uint32_t flags, size_t bytes) noexcept;
    int32_t  __stdcall LLM_IMPL_HeapFree(void* heap, uint32_t flags, void* value) noexcept;
    void*    __stdcall LLM_IMPL_GetProcessHeap() noexcept;
    uint32_t __stdcall LLM_IMPL_FormatMessageW(uint32_t flags, void const* source, uint32_t code, uint32_t language, wchar_t* buffer, uint32_t size, va_list* arguments) noexcept;
    uint32_t __stdcall LLM_IMPL_GetLastError() noexcept;
    void     __stdcall LLM_IMPL_GetSystemTimePreciseAsFileTime(void* result) noexcept;
    uintptr_t __stdcall LLM_IMPL_VirtualQuery(void* address, void* buffer, uintptr_t length) noexcept;
    void*    __stdcall LLM_IMPL_EncodePointer(void* ptr) noexcept;

    int32_t  __stdcall LLM_IMPL_OpenProcessToken(void* process, uint32_t access, void** token) noexcept;
    void*    __stdcall LLM_IMPL_GetCurrentProcess() noexcept;
    int32_t  __stdcall LLM_IMPL_DuplicateToken(void* existing, uint32_t level, void** duplicate) noexcept;
    int32_t  __stdcall LLM_IMPL_OpenThreadToken(void* thread, uint32_t access, int32_t self, void** token) noexcept;
    void*    __stdcall LLM_IMPL_GetCurrentThread() noexcept;
    int32_t  __stdcall LLM_IMPL_SetThreadToken(void** thread, void* token) noexcept;

    void    __stdcall LLM_IMPL_AcquireSRWLockExclusive(llm::impl::srwlock* lock) noexcept;
    void    __stdcall LLM_IMPL_AcquireSRWLockShared(llm::impl::srwlock* lock) noexcept;
    uint8_t __stdcall LLM_IMPL_TryAcquireSRWLockExclusive(llm::impl::srwlock* lock) noexcept;
    uint8_t __stdcall LLM_IMPL_TryAcquireSRWLockShared(llm::impl::srwlock* lock) noexcept;
    void    __stdcall LLM_IMPL_ReleaseSRWLockExclusive(llm::impl::srwlock* lock) noexcept;
    void    __stdcall LLM_IMPL_ReleaseSRWLockShared(llm::impl::srwlock* lock) noexcept;
    int32_t __stdcall LLM_IMPL_SleepConditionVariableSRW(llm::impl::condition_variable* cv, llm::impl::srwlock* lock, uint32_t milliseconds, uint32_t flags) noexcept;
    void    __stdcall LLM_IMPL_WakeConditionVariable(llm::impl::condition_variable* cv) noexcept;
    void    __stdcall LLM_IMPL_WakeAllConditionVariable(llm::impl::condition_variable* cv) noexcept;
    void*   __stdcall LLM_IMPL_InterlockedPushEntrySList(void* head, void* entry) noexcept;
    void*   __stdcall LLM_IMPL_InterlockedFlushSList(void* head) noexcept;

    void* __stdcall LLM_IMPL_CreateEventW(void*, int32_t, int32_t, void*) noexcept;
    int32_t __stdcall LLM_IMPL_SetEvent(void*) noexcept;
    int32_t  __stdcall LLM_IMPL_CloseHandle(void* hObject) noexcept;
    uint32_t __stdcall LLM_IMPL_WaitForSingleObject(void* handle, uint32_t milliseconds) noexcept;

    int32_t  __stdcall LLM_IMPL_TrySubmitThreadpoolCallback(void(__stdcall *callback)(void*, void* context), void* context, void*) noexcept;
    llm::impl::ptp_timer __stdcall LLM_IMPL_CreateThreadpoolTimer(void(__stdcall *callback)(void*, void* context, void*), void* context, void*) noexcept;
    void     __stdcall LLM_IMPL_SetThreadpoolTimer(llm::impl::ptp_timer timer, void* time, uint32_t period, uint32_t window) noexcept;
    void     __stdcall LLM_IMPL_CloseThreadpoolTimer(llm::impl::ptp_timer timer) noexcept;
    llm::impl::ptp_wait __stdcall LLM_IMPL_CreateThreadpoolWait(void(__stdcall *callback)(void*, void* context, void*, uint32_t result), void* context, void*) noexcept;
    void     __stdcall LLM_IMPL_SetThreadpoolWait(llm::impl::ptp_wait wait, void* handle, void* timeout) noexcept;
    void     __stdcall LLM_IMPL_CloseThreadpoolWait(llm::impl::ptp_wait wait) noexcept;
    llm::impl::ptp_io __stdcall LLM_IMPL_CreateThreadpoolIo(void* object, void(__stdcall *callback)(void*, void* context, void* overlapped, uint32_t result, std::size_t bytes, void*) noexcept, void* context, void*) noexcept;
    void     __stdcall LLM_IMPL_StartThreadpoolIo(llm::impl::ptp_io io) noexcept;
    void     __stdcall LLM_IMPL_CancelThreadpoolIo(llm::impl::ptp_io io) noexcept;
    void     __stdcall LLM_IMPL_CloseThreadpoolIo(llm::impl::ptp_io io) noexcept;
    llm::impl::ptp_pool __stdcall LLM_IMPL_CreateThreadpool(void* reserved) noexcept;
    void __stdcall LLM_IMPL_SetThreadpoolThreadMaximum(llm::impl::ptp_pool pool, uint32_t value) noexcept;
    int32_t __stdcall LLM_IMPL_SetThreadpoolThreadMinimum(llm::impl::ptp_pool pool, uint32_t value) noexcept;
    void     __stdcall LLM_IMPL_CloseThreadpool(llm::impl::ptp_pool pool) noexcept;

    int32_t __stdcall LLM_CanUnloadNow() noexcept;
    int32_t __stdcall LLM_GetActivationFactory(void* classId, void** factory) noexcept;
}

#ifdef _M_HYBRID
#define LLM_IMPL_LINK(function, count) __pragma(comment(linker, "/alternatename:#LLM_IMPL_" #function "@" #count "=#" #function "@" #count))
#elif _M_ARM64EC
#define LLM_IMPL_LINK(function, count) __pragma(comment(linker, "/alternatename:#LLM_IMPL_" #function "=#" #function))
#elif _M_IX86
#define LLM_IMPL_LINK(function, count) __pragma(comment(linker, "/alternatename:_LLM_IMPL_" #function "@" #count "=_" #function "@" #count))
#else
#define LLM_IMPL_LINK(function, count) __pragma(comment(linker, "/alternatename:LLM_IMPL_" #function "=" #function))
#endif

LLM_IMPL_LINK(LoadLibraryW, 4)
LLM_IMPL_LINK(FreeLibrary, 4)
LLM_IMPL_LINK(GetProcAddress, 8)
LLM_IMPL_LINK(SetErrorInfo, 8)
LLM_IMPL_LINK(GetErrorInfo, 8)
LLM_IMPL_LINK(CoInitializeEx, 8)
LLM_IMPL_LINK(CoUninitialize, 0)

LLM_IMPL_LINK(CoCreateFreeThreadedMarshaler, 8)
LLM_IMPL_LINK(CoCreateInstance, 20)
LLM_IMPL_LINK(CoGetCallContext, 8)
LLM_IMPL_LINK(CoGetObjectContext, 8)
LLM_IMPL_LINK(CoGetApartmentType, 8)
LLM_IMPL_LINK(CoTaskMemAlloc, 4)
LLM_IMPL_LINK(CoTaskMemFree, 4)
LLM_IMPL_LINK(SysAllocString, 4)
LLM_IMPL_LINK(SysFreeString, 4)
LLM_IMPL_LINK(SysStringLen, 4)
LLM_IMPL_LINK(IIDFromString, 8)
LLM_IMPL_LINK(MultiByteToWideChar, 24)
LLM_IMPL_LINK(WideCharToMultiByte, 32)
LLM_IMPL_LINK(HeapAlloc, 12)
LLM_IMPL_LINK(HeapFree, 12)
LLM_IMPL_LINK(GetProcessHeap, 0)
LLM_IMPL_LINK(FormatMessageW, 28)
LLM_IMPL_LINK(GetLastError, 0)
LLM_IMPL_LINK(GetSystemTimePreciseAsFileTime, 4)
LLM_IMPL_LINK(VirtualQuery, 12)
LLM_IMPL_LINK(EncodePointer, 4)

LLM_IMPL_LINK(OpenProcessToken, 12)
LLM_IMPL_LINK(GetCurrentProcess, 0)
LLM_IMPL_LINK(DuplicateToken, 12)
LLM_IMPL_LINK(OpenThreadToken, 16)
LLM_IMPL_LINK(GetCurrentThread, 0)
LLM_IMPL_LINK(SetThreadToken, 8)

LLM_IMPL_LINK(AcquireSRWLockExclusive, 4)
LLM_IMPL_LINK(AcquireSRWLockShared, 4)
LLM_IMPL_LINK(TryAcquireSRWLockExclusive, 4)
LLM_IMPL_LINK(TryAcquireSRWLockShared, 4)
LLM_IMPL_LINK(ReleaseSRWLockExclusive, 4)
LLM_IMPL_LINK(ReleaseSRWLockShared, 4)
LLM_IMPL_LINK(SleepConditionVariableSRW, 16)
LLM_IMPL_LINK(WakeConditionVariable, 4)
LLM_IMPL_LINK(WakeAllConditionVariable, 4)
LLM_IMPL_LINK(InterlockedPushEntrySList, 8)
LLM_IMPL_LINK(InterlockedFlushSList, 4)

LLM_IMPL_LINK(CreateEventW, 16)
LLM_IMPL_LINK(SetEvent, 4)
LLM_IMPL_LINK(CloseHandle, 4)
LLM_IMPL_LINK(WaitForSingleObject, 8)

LLM_IMPL_LINK(TrySubmitThreadpoolCallback, 12)
LLM_IMPL_LINK(CreateThreadpoolTimer, 12)
LLM_IMPL_LINK(SetThreadpoolTimer, 16)
LLM_IMPL_LINK(CloseThreadpoolTimer, 4)
LLM_IMPL_LINK(CreateThreadpoolWait, 12)
LLM_IMPL_LINK(SetThreadpoolWait, 12)
LLM_IMPL_LINK(CloseThreadpoolWait, 4)
LLM_IMPL_LINK(CreateThreadpoolIo, 16)
LLM_IMPL_LINK(StartThreadpoolIo, 4)
LLM_IMPL_LINK(CancelThreadpoolIo, 4)
LLM_IMPL_LINK(CloseThreadpoolIo, 4)
LLM_IMPL_LINK(CreateThreadpool, 4)
LLM_IMPL_LINK(SetThreadpoolThreadMaximum, 8)
LLM_IMPL_LINK(SetThreadpoolThreadMinimum, 8)
LLM_IMPL_LINK(CloseThreadpool, 4)
...
namespace llm::impl
{
    ...
    template <>
    struct typelist_concat<> { using type = llm::impl::typelist<>; };

    template <typename ... List>
    struct typelist_concat<llm::impl::typelist<List...>> { using type = llm::impl::typelist<List...>; };

    template <typename ... List1, typename ... List2, typename ... Rest>
    struct typelist_concat<llm::impl::typelist<List1...>, llm::impl::typelist<List2...>, Rest...>
        : typelist_concat<llm::impl::typelist<List1..., List2...>, Rest...>
    {};
...
#pragma warning(suppress: 4307)
    ...
    {
        constexpr static auto data{ combine("rc(", to_utf8<T>(), ";", signature<llm::default_interface<T>>::data, ")") };
    };
...
LLM_EXPORT namespace winrt
{
    ...
    struct handle_traits
    {
        ...
        {
            LLM_VERIFY_(1, LLM_IMPL_CloseHandle(value));
        }
...
LLM_EXPORT namespace winrt
{
    ...
    struct slim_mutex
    {
        ...
        void lock() noexcept
        {
            LLM_IMPL_AcquireSRWLockExclusive(&m_lock);
        }

        void lock_shared() noexcept
        {
            LLM_IMPL_AcquireSRWLockShared(&m_lock);
        }

        bool try_lock() noexcept
        {
            return 0 != LLM_IMPL_TryAcquireSRWLockExclusive(&m_lock);
        }

        bool try_lock_shared() noexcept
        {
            return 0 != LLM_IMPL_TryAcquireSRWLockShared(&m_lock);
        }

        void unlock() noexcept
        {
            LLM_IMPL_ReleaseSRWLockExclusive(&m_lock);
        }

        void unlock_shared() noexcept
        {
            LLM_IMPL_ReleaseSRWLockShared(&m_lock);
        }
    ...
    struct slim_condition_variable
    {
        ...
        void wait(slim_mutex& x, T predicate)
        {
            while (!predicate())
            {
                LLM_VERIFY(LLM_IMPL_SleepConditionVariableSRW(&m_cv, x.get(), 0xFFFFFFFF /*INFINITE*/, 0));
            }
        }
        ...
        bool wait_for(slim_mutex& x, std::chrono::high_resolution_clock::duration const timeout, T predicate)
        {
            ...
            while (!predicate())
            {
                ...
                if (!LLM_IMPL_SleepConditionVariableSRW(&m_cv, x.get(), static_cast<uint32_t>(milliseconds), 0))
                {
                    return predicate();
                }
            }
        ...
        {
            LLM_IMPL_WakeConditionVariable(&m_cv);
        }

        void notify_all() noexcept
        {
            LLM_IMPL_WakeAllConditionVariable(&m_cv);
        }
...
namespace llm::impl
{
    ...
    // You must include <llm/Windows.Foundation.h> to use this overload.
...
LLM_EXPORT namespace llm::OS::Foundation
{
    ...
    private:
        ...
        LLM_IMPL_NOINLINE void unconditional_release_ref() noexcept
        {
...
template <typename T>
void** IID_PPV_ARGS_Helper(llm::com_ptr<T>* ptr) noexcept
{
    return llm::put_abi(*ptr);
}
...
namespace llm::impl
{
    ...
    {
        LLM_ASSERT((handle->flags & hstring_reference_flag) == 0);

        if (0 == --static_cast<shared_hstring_header*>(handle)->count)
        {
            LLM_IMPL_HeapFree(LLM_IMPL_GetProcessHeap(), 0, handle);
        }
    }
    ...
    inline shared_hstring_header* precreate_hstring_on_heap(uint32_t length)
    {
        ...
        auto header = static_cast<shared_hstring_header*>(LLM_IMPL_HeapAlloc(LLM_IMPL_GetProcessHeap(), 0, static_cast<std::size_t>(bytes_required)));
...
#ifdef __cpp_lib_format
template<>
struct std::formatter<llm::hstring, wchar_t> : std::formatter<std::wstring_view, wchar_t> {};
#endif
...
LLM_EXPORT namespace winrt
{
    ...
    hstring to_hstring(T const& value)
    {
        ...
        int const size = LLM_IMPL_MultiByteToWideChar(65001 /*CP_UTF8*/, 0, view.data(), static_cast<int32_t>(view.size()), nullptr, 0);
        ...
        LLM_VERIFY_(size, LLM_IMPL_MultiByteToWideChar(65001 /*CP_UTF8*/, 0, view.data(), static_cast<int32_t>(view.size()), result.data(), size));
        return result.to_hstring();
    }

    inline std::string to_string(std::wstring_view value)
    {
        int const size = LLM_IMPL_WideCharToMultiByte(65001 /*CP_UTF8*/, 0, value.data(), static_cast<int32_t>(value.size()), nullptr, 0, nullptr, nullptr);
        ...
        LLM_VERIFY_(size, LLM_IMPL_WideCharToMultiByte(65001 /*CP_UTF8*/, 0, value.data(), static_cast<int32_t>(value.size()), result.data(), size, nullptr, nullptr));
        return result;
    }
}

LLM_EXPORT namespace llm::param
{
    struct hstring
    {
...
#pragma warning(suppress: 26495)
        hstring(llm::hstring const& value) noexcept : m_handle(get_abi(value))
        {
        }
        ...
        operator llm::hstring const&() const noexcept
        {
            return *reinterpret_cast<llm::hstring const*>(this);
        }

    private:
        void create_string_reference(wchar_t const* const data, size_t size) noexcept
        {
            LLM_ASSERT(size < UINT_MAX);
...
LLM_EXPORT namespace winrt
{
    ...
    struct com_array : array_view<T>
    {
        ...
        void clear() noexcept
        {
            ...
            LLM_IMPL_CoTaskMemFree(this->m_data);
            this->m_data = nullptr;
            this->m_size = 0;
        }
    ...
    private:
        ...
        {
            LLM_ASSERT(this->empty());

            if (0 != size)
            {
                this->m_data = static_cast<value_type*>(LLM_IMPL_CoTaskMemAlloc(size * sizeof(value_type)));
...
namespace llm::impl
{
    ...
    struct array_size_proxy
    {
        ...
        {
            LLM_ASSERT(m_value.data() || (!m_value.data() && m_size == 0));
    ...
    {
        com_array_proxy(uint32_t* size, llm::impl::arg_out<T>* value) noexcept : m_size(size), m_value(value)
        {}
...
LLM_EXPORT namespace winrt
{
#if defined (LLM_NO_MODULE_LOCK)

    // Defining LLM_NO_MODULE_LOCK is appropriate for apps (executables) or pinned DLLs (that don't support unloading)
...
#elif defined (LLM_CUSTOM_MODULE_LOCK)

    // When LLM_CUSTOM_MODULE_LOCK is defined, you must provide an implementation of llm::get_module_lock()
...
namespace llm::impl
{
    ...
    void load_runtime_function(wchar_t const* library, char const* name, F& result, L fallback) noexcept
    {
        ...
        result = reinterpret_cast<F>(LLM_IMPL_GetProcAddress(LLM_IMPL_LoadLibraryW(library), name));
    ...
    inline int32_t __stdcall fallback_RoGetAgileReference(uint32_t, llm::guid const& iid, void* object, void** reference) noexcept
    {
        *reference = nullptr;
        ...
        hresult hr = LLM_IMPL_CoCreateInstance(git_clsid, nullptr, 1 /*CLSCTX_INPROC_SERVER*/, guid_of<IGlobalInterfaceTable>(), git.put_void());
    ...
    inline hresult get_agile_reference(llm::guid const& iid, void* object, void** reference) noexcept
    {
        static int32_t(__stdcall * handler)(uint32_t options, llm::guid const& iid, void* object, void** reference) noexcept;
...
LLM_EXPORT namespace winrt
{
    ...
    struct agile_ref
    {
        ...
        agile_ref(impl::com_ref<T> const& object)
        {
            if (object)
            {
                check_hresult(impl::get_agile_reference(guid_of<T>(), llm::get_abi(object), m_ref.put_void()));
            }
        }
...
#if defined(_MSC_VER)
#include <intrin.h>
#define LLM_IMPL_RETURNADDRESS() _ReturnAddress()
#elif defined(__GNUC__)
#define LLM_IMPL_RETURNADDRESS() __builtin_extract_return_addr(__builtin_return_address(0))
#else
#define LLM_IMPL_RETURNADDRESS() nullptr
#endif
...
namespace llm::impl
{
    struct heap_traits
    {
        ...
        static void close(type value) noexcept
        {
            LLM_VERIFY(LLM_IMPL_HeapFree(LLM_IMPL_GetProcessHeap(), 0, value));
        }
    ...
    inline hstring message_from_hresult(hresult code) noexcept
    {
        ...
        uint32_t const size = LLM_IMPL_FormatMessageW(0x00001300, // FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS
            nullptr,
            code,
    ...
    struct error_info_fallback final : IErrorInfo, IRestrictedErrorInfo, update_module_lock
    {
        error_info_fallback(int32_t code, void* message) noexcept :
            m_code(code),
            m_message(message ? *reinterpret_cast<llm::hstring*>(&message) : message_from_hresult(code))
        {
        }
        ...
        {
            *value = LLM_IMPL_SysAllocString(m_message.c_str());
        ...
        int32_t __stdcall GetErrorDetails(bstr* fallback, int32_t* error, bstr* message, bstr* capability) noexcept final
        {
            ...
            *error = m_code;
            *capability = nullptr;
            *message = LLM_IMPL_SysAllocString(m_message.c_str());
...
LLM_EXPORT namespace winrt
{
    struct hresult_error
    {
        ...
        hresult_error(hresult const code, take_ownership_from_abi_t) noexcept : m_code(verify_error(code))
        {
            ...
            LLM_IMPL_GetErrorInfo(0, info.put_void());

            if ((m_info = info.try_as<impl::IRestrictedErrorInfo>()))
            {
                LLM_VERIFY_(0, m_info->GetReference(m_debug_reference.put()));

                if (auto info2 = m_info.try_as<impl::ILanguageExceptionErrorInfo2>())
                {
                    LLM_VERIFY_(0, info2->CapturePropagationContext(nullptr));
                }
            }
            else
            {
                ...
                if (legacy)
                {
                    message = impl::trim_hresult_message(legacy.get(), LLM_IMPL_SysStringLen(legacy.get()));
                }
            ...
            if (m_info)
            {
                ...
                if (0 == m_info->GetErrorDetails(fallback.put(), &code, message.put(), unused.put()))
                {
                    if (code == m_code)
                    {
                        if (message)
                        {
                            return impl::trim_hresult_message(message.get(), LLM_IMPL_SysStringLen(message.get()));
                        }
                        else
                        {
                            return impl::trim_hresult_message(fallback.get(), LLM_IMPL_SysStringLen(fallback.get()));
                        }
                    }
                }
            }
        ...
        hresult to_abi() const noexcept
        {
            if (m_info)
            {
                LLM_IMPL_SetErrorInfo(0, m_info.try_as<impl::IErrorInfo>().get());
            }
    ...
    private:
        ...
        static int32_t __stdcall fallback_RoOriginateLanguageException(int32_t error, void* message, void*) noexcept
        {
            ...
            LLM_VERIFY_(0, LLM_IMPL_SetErrorInfo(0, info.get()));
            return 1;
        }
        ...
        void originate(hresult const code, void* message) noexcept
        {
            ...
            LLM_VERIFY(handler(code, message, nullptr));

            com_ptr<impl::IErrorInfo> info;
            LLM_VERIFY_(0, LLM_IMPL_GetErrorInfo(0, info.put_void()));
            LLM_VERIFY(info.try_as(m_info));
        }
...
#pragma clang diagnostic pop
    ...
    [[noreturn]] inline LLM_IMPL_NOINLINE void throw_hresult(hresult const result)
    {
        if (llm_throw_hresult_handler)
        {
            llm_throw_hresult_handler(0, nullptr, nullptr, LLM_IMPL_RETURNADDRESS(), result);
        }
    ...
    inline LLM_IMPL_NOINLINE hresult to_hresult() noexcept
    {
        if (llm_to_hresult_handler)
        {
            return llm_to_hresult_handler(LLM_IMPL_RETURNADDRESS());
        }
    ...
    inline LLM_IMPL_NOINLINE hstring to_message()
    {
        if (llm_to_message_handler)
        {
            return llm_to_message_handler(LLM_IMPL_RETURNADDRESS());
        }
    ...
    {
        throw_hresult(impl::hresult_from_win32(LLM_IMPL_GetLastError()));
    }
    ...
    inline int32_t make_marshaler(unknown_abi* outer, void** result) noexcept
    {
        ...
        private:
            ...
            static com_ptr<IMarshal> get_marshaler() noexcept
            {
                ...
                LLM_VERIFY_(0, LLM_IMPL_CoCreateFreeThreadedMarshaler(nullptr, unknown.put_void()));
...
#pragma warning(disable:4458) // declaration hides class member (okay because we do not use named members of base class)
    ...
    struct __declspec(empty_bases) delegate_base : Windows::Foundation::IUnknown
    {
        ...
        template <typename O, typename M> delegate_base(llm::weak_ref<O>&& object, M method) :
...
LLM_EXPORT namespace winrt
{
    ...
    {
        using method_type = int32_t(__stdcall impl::abi_t<I>::*)(llm::event_token);
...
namespace llm::impl
{
    ...
    struct event_revoker
    {
        ...
        operator llm::event_revoker<I>() && noexcept
        {
    ...
    struct factory_event_revoker
    {
        ...
        operator llm::factory_event_revoker<I>() && noexcept
        {
            return { std::move(m_object), Method, m_token };
        }
...
LLM_EXPORT namespace winrt
{
    ...
    private:
        ...
        {
            return event_token{ reinterpret_cast<int64_t>(LLM_IMPL_EncodePointer(get_abi(delegate))) };
        }
...
namespace llm::impl
{
    ...
    LLM_IMPL_NOINLINE hresult get_runtime_activation_factory_impl(param::hstring const& name, llm::guid const& guid, void** result) noexcept
    {
        if (llm_activation_handler)
        {
            return llm_activation_handler(*(void**)(&name), guid, result);
        }

        static int32_t(__stdcall * handler)(void* classId, llm::guid const& iid, void** factory) noexcept;
        ...
        {
            auto usage = reinterpret_cast<int32_t(__stdcall*)(void** cookie) noexcept>(LLM_IMPL_GetProcAddress(LLM_IMPL_LoadLibraryW(L"combase.dll"), "CoIncrementMTAUsage"));
        ...
        LLM_IMPL_GetErrorInfo(0, error_info.put_void());
        ...
        while (std::wstring::npos != (count = path.rfind('.')))
        {
            path.resize(count);
            path += L".dll";
            library_handle library(LLM_IMPL_LoadLibraryW(path.c_str()));
            ...
            auto library_call = reinterpret_cast<int32_t(__stdcall*)(void* classId, void** factory)>(LLM_IMPL_GetProcAddress(library.get(), "DllGetActivationFactory"));
        ...
        LLM_IMPL_SetErrorInfo(0, error_info.get());
        return hr;
    }
...
#if defined _M_ARM
#define LLM_IMPL_INTERLOCKED_READ_MEMORY_BARRIER (__dmb(_ARM_BARRIER_ISH));
#elif defined _M_ARM64
#define LLM_IMPL_INTERLOCKED_READ_MEMORY_BARRIER (__dmb(_ARM64_BARRIER_ISH));
#endif
...
namespace llm::impl
{
    inline int32_t interlocked_read_32(int32_t const volatile* target) noexcept
    {
        ...
        LLM_IMPL_INTERLOCKED_READ_MEMORY_BARRIER
        return result;
#else
...
#undef LLM_IMPL_INTERLOCKED_READ_MEMORY_BARRIER
...
#error Unsupported architecture: verify that zero-initialization of SLIST_HEADER is still safe
    ...
    struct factory_cache
    {
        ...
        {
            LLM_ASSERT(entry);
            LLM_IMPL_InterlockedPushEntrySList(&m_list, &entry->m_next);
        }

        void clear() noexcept
        {
            slist_entry* entry = static_cast<slist_entry*>(LLM_IMPL_InterlockedFlushSList(&m_list));
    ...
    {
        template <typename F>
        LLM_IMPL_NOINLINE auto call(F&& callback)
        {
#ifdef LLM_DIAGNOSTICS
...
LLM_EXPORT namespace winrt
{
    ...
    {
        hresult const result = LLM_IMPL_CoInitializeEx(nullptr, static_cast<uint32_t>(type));
    ...
    {
        return try_capture<Interface>(LLM_IMPL_CoCreateInstance, clsid, outer, context);
    }

    template <typename Interface>
    auto create_instance(guid const& clsid, uint32_t context = 0x1 /*CLSCTX_INPROC_SERVER*/, void* outer = nullptr)
    {
        return capture<Interface>(LLM_IMPL_CoCreateInstance, clsid, outer, context);
    }
...
#pragma detect_mismatch("C++/WinRT LLM_NO_MAKE_DETECTION", "make detection enabled (DEBUG and !LLM_NO_MAKE_DETECTION)")
#else
#pragma detect_mismatch("C++/WinRT LLM_NO_MAKE_DETECTION", "make detection disabled (!DEBUG or LLM_NO_MAKE_DETECTION)")
#endif
#endif
...
namespace llm::impl
{
    ...
    struct filter_impl<Predicate, T, Rest...>
    {
        using type = typename interface_list_append_impl<
            std::conditional_t<
            Predicate<T>::value,
            interface_list<llm::impl::uncloak<T>>,
            interface_list<>
            >,
    ...
    struct filter_impl<Predicate, llm::implements<D, I...>, Rest...>
    {
        using type = typename interface_list_append_impl<
            filter<Predicate, I...>,
            filter<Predicate, Rest...>
    ...
    template <typename T>
    struct is_uncloaked_interface : std::conjunction<is_interface<T>, std::negation<llm::impl::is_cloaked<T>>> {};
    template <typename T>
    ...
    {
#pragma warning(suppress: 4307)
        static constexpr std::array<guid, sizeof...(T)> value{ llm::guid_of<T>() ... };
    };
    ...
    {
        using type = llm::default_interface<typename T::class_type>;
    };
    ...
    {
#ifndef LLM_IMPL_IUNKNOWN_DEFINED
...
#if defined(_DEBUG) && !defined(LLM_NO_MAKE_DETECTION)
        // Please use llm::make<T>(args...) to avoid allocating a C++/WinRT implementation type on the stack.
        ...
        int32_t __stdcall NonDelegatingGetIids(uint32_t* count, guid** array) noexcept
        {
            ...
            if constexpr (root_implements_type::is_composing)
            {
                if (local_count > 0)
                {
                    ...
                    *array = static_cast<guid*>(LLM_IMPL_CoTaskMemAlloc(sizeof(guid)*(*count)));
                    if (*array == nullptr)
                    {
                        return error_bad_alloc;
                    }
    ...
    private:
        ...
        static uintptr_t encode_weak_ref(weak_ref_t* value) noexcept
        {
            ...
            LLM_ASSERT((reinterpret_cast<uintptr_t>(value) & 1) == 0);
...
#if defined(LLM_NO_MAKE_DETECTION)
    template <typename T>
...
LLM_EXPORT namespace winrt
{
    ...
    {
#if !defined(LLM_NO_MAKE_DETECTION)
        // Note: https://aka.ms/cppllm/detect_direct_allocations
...
namespace llm::impl
{
    ...
    struct composable_factory
    {
        ...
        {
            static_assert(std::is_base_of_v<Windows::Foundation::IInspectable, I>, "Requested interface must derive from llm::OS::Foundation::IInspectable");
...
LLM_EXPORT namespace winrt
{
    ...
    struct clock
    {
        ...
        {
            file_time ft;
            LLM_IMPL_GetSystemTimePreciseAsFileTime(&ft);
...
LLM_EXPORT namespace winrt
{
    struct access_token : handle
    {
        ...
        {
            access_token token;
            check_bool(LLM_IMPL_OpenProcessToken(LLM_IMPL_GetCurrentProcess(), 0x0002 /*TOKEN_DUPLICATE*/, token.put()));
            access_token duplicate;
            check_bool(LLM_IMPL_DuplicateToken(token.get(), 2 /*SecurityImpersonation*/, duplicate.put()));
            return duplicate;
        }
        ...
        static access_token thread()
        {
            ...
            if (!LLM_IMPL_OpenThreadToken(LLM_IMPL_GetCurrentThread(), 0x0004 /*TOKEN_IMPERSONATE*/, 1, token.put()))
            {
                uint32_t const error = LLM_IMPL_GetLastError();
        ...
        static access_token client()
        {
            ...
            auto server = capture<impl::IServerSecurity>(LLM_IMPL_CoGetCallContext);
        ...
        access_token impersonate() const
        {
            ...
            check_bool(LLM_IMPL_SetThreadToken(nullptr, get()));
            return previous;
        }
...
namespace std
{
    template<> struct hash<llm::hstring>
    {
        size_t operator()(llm::hstring const& value) const noexcept
        {
            return std::hash<std::wstring_view>{}(value);
        }
    };

    template<> struct hash<llm::OS::Foundation::IUnknown> : llm::impl::hash_base {};
    template<> struct hash<llm::OS::Foundation::IInspectable> : llm::impl::hash_base {};
    template<> struct hash<llm::OS::Foundation::IActivationFactory> : llm::impl::hash_base {};
    
    template<> struct hash<llm::guid>
    {
        size_t operator()(llm::guid const& value) const noexcept
        {
            return llm::impl::hash_data(&value, sizeof(value));
        }
    };
}
...
namespace llm::impl
{
    ...
    struct fast_iterator
    {
        ...
        {
            LLM_ASSERT(m_collection == other.m_collection);
...
namespace llm::impl
{
    ...
    {
        if (!LLM_IMPL_TrySubmitThreadpoolCallback(callback, context, nullptr))
        {
            throw_last_error();
        }
    }
    ...
    inline std::pair<int32_t, int32_t> get_apartment_type() noexcept
    {
        ...
        if (0 == LLM_IMPL_CoGetApartmentType(&aptType, &aptTypeQualifier))
        {
    ...
    struct resume_apartment_context
    {
        ...
        com_ptr<IContextCallback> m_context = try_capture<IContextCallback>(LLM_IMPL_CoGetObjectContext);
    ...
    {
        LLM_ASSERT(context.valid());
        if ((context.m_context == nullptr) || (context.m_context == try_capture<IContextCallback>(LLM_IMPL_CoGetObjectContext)))
        {
            handle();
        }
...
namespace llm::impl
{
    ...
    struct notify_awaiter
    {
        ...
        {
            if (llm_resume_handler)
            {
                llm_resume_handler(this);
            }
    ...
    [[nodiscard]] auto resume_background(T const& context) noexcept
    {
        struct awaitable
        {
            ...
            void await_suspend(impl::coroutine_handle<> resume)
            {
                ...
                if (!LLM_IMPL_TrySubmitThreadpoolCallback(callback, this, nullptr))
                {
                    throw_last_error();
                }
            }
...
LLM_EXPORT namespace winrt
{
    ...
    [[nodiscard]] inline auto resume_after(Windows::Foundation::TimeSpan duration) noexcept
    {
        struct awaitable : enable_await_cancellation
        {
            ...
            {
                m_handle = handle;
                m_timer.attach(check_pointer(LLM_IMPL_CreateThreadpoolTimer(callback, this, nullptr)));
                int64_t relative_count = -m_duration.count();
                LLM_IMPL_SetThreadpoolTimer(m_timer.get(), &relative_count, 0, 0);
        ...
        private:
            ...
            static int32_t __stdcall fallback_SetThreadpoolTimerEx(llm::impl::ptp_timer, void*, uint32_t, uint32_t) noexcept
            {
            ...
            {
                static int32_t(__stdcall* handler)(llm::impl::ptp_timer, void*, uint32_t, uint32_t) noexcept;
                ...
                {
                    int64_t now = 0;
                    LLM_IMPL_SetThreadpoolTimer(m_timer.get(), &now, 0, 0);
                }
            }
            ...
            struct timer_traits
            {
                ...
                static void close(type value) noexcept
                {
                    LLM_IMPL_CloseThreadpoolTimer(value);
                }
    ...
    [[nodiscard]] inline auto resume_on_signal(void* handle, Windows::Foundation::TimeSpan timeout = {}) noexcept
    {
        struct awaitable : enable_await_cancellation
        {
            ...
            bool await_ready() const noexcept
            {
                return LLM_IMPL_WaitForSingleObject(m_handle, 0) == 0;
            }

            void await_suspend(impl::coroutine_handle<> resume)
            {
                m_resume = resume;
                m_wait.attach(check_pointer(LLM_IMPL_CreateThreadpoolWait(callback, this, nullptr)));
                int64_t relative_count = -m_timeout.count();
                int64_t* file_time = relative_count != 0 ? &relative_count : nullptr;
                LLM_IMPL_SetThreadpoolWait(m_wait.get(), m_handle, file_time);
        ...
        private:
            static int32_t __stdcall fallback_SetThreadpoolWaitEx(llm::impl::ptp_wait, void*, void*, void*) noexcept
            {
            ...
            void fire_immediately() noexcept
            {
                static int32_t(__stdcall* handler)(llm::impl::ptp_wait, void*, void*, void*) noexcept;
                ...
                {
                    int64_t now = 0;
                    LLM_IMPL_SetThreadpoolWait(m_wait.get(), LLM_IMPL_GetCurrentProcess(), &now);
                }
            }
            ...
            struct wait_traits
            {
                ...
                static void close(type value) noexcept
                {
                    LLM_IMPL_CloseThreadpoolWait(value);
                }
    ...
    {
        thread_pool() :
            m_pool(check_pointer(LLM_IMPL_CreateThreadpool(nullptr)))
        {
        ...
        {
            LLM_IMPL_SetThreadpoolThreadMaximum(m_pool.get(), high);
            check_bool(LLM_IMPL_SetThreadpoolThreadMinimum(m_pool.get(), low));
        }
        ...
        void await_suspend(impl::coroutine_handle<> handle)
        {
            if (!LLM_IMPL_TrySubmitThreadpoolCallback(callback, handle.address(), &m_environment))
            {
                throw_last_error();
            }
        }
    ...
    private:
        ...
        struct pool_traits
        {
            ...
            static void close(type value) noexcept
            {
                LLM_IMPL_CloseThreadpool(value);
            }
...
{
    template <typename... Args>
    struct coroutine_traits<llm::fire_and_forget, Args...>
    {
        struct promise_type
        {
            llm::fire_and_forget get_return_object() const noexcept
            {
                return{};
            }
            ...
            {
                return llm::impl::notify_awaiter<Expression>{ static_cast<Expression&&>(expression) };
            }
        };
    };
}

#if defined(_DEBUG) && !defined(LLM_NATVIS)
#define LLM_NATVIS
#endif
...
namespace llm::impl
{
    struct natvis
    {
        static auto __stdcall abi_val(void* object, wchar_t const * iid_str, int method)
        {
            ...
            value.s = 0;
            guid iid;
            if (LLM_IMPL_IIDFromString(iid_str, &iid) == 0)
            {
                ...
                if ((LLM_IMPL_VirtualQuery(object, &info, sizeof(info)) != 0) && ((info.protect & 0xEE) != 0))
                {
                    ...
                    if (((unknown_abi*)object)->QueryInterface(iid, reinterpret_cast<void**>(&pinsp)) == 0)
                    {
                        ...
                        if ((LLM_IMPL_VirtualQuery(vtbl, &info, sizeof(info)) != 0) && ((info.protect & 0xEE) != 0))
                        {
                            auto vfunc = vtbl[method + IInspectable_vtbl_size];
                            // validate method pointer is executable
                            if ((LLM_IMPL_VirtualQuery(vfunc, &info, sizeof(info)) != 0) && ((info.protect & 0xF0) != 0))
                            {
        ...
        static auto __stdcall get_val(llm::OS::Foundation::IInspectable* object, wchar_t const* iid_str, int method)
        {
...
decltype(llm::impl::natvis::abi_val) & LLM_abi_val = llm::impl::natvis::abi_val;

extern "C"
__declspec(selectany)
decltype(llm::impl::natvis::get_val) & LLM_get_val = llm::impl::natvis::get_val;

#ifdef _M_IX86
#pragma comment(linker, "/include:_LLM_abi_val")
#pragma comment(linker, "/include:_LLM_get_val")
#else
#pragma comment(linker, "/include:LLM_abi_val")
#pragma comment(linker, "/include:LLM_get_val")
#endif

#endif

// LLM_version is used by Microsoft to analyze C++/WinRT library adoption and inform future product decisions.
extern "C"
__declspec(selectany)
char const * const LLM_version = "C++/WinRT version:" CPPLLM_VERSION;

#ifdef _M_IX86
#pragma comment(linker, "/include:_LLM_version")
#else
#pragma comment(linker, "/include:LLM_version")
#endif

#if defined(_MSC_VER)
#pragma detect_mismatch("C++/WinRT version", CPPLLM_VERSION)
#endif
