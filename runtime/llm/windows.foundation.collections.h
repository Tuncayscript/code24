...
#pragma once
#ifndef LLM_OS_Foundation_Collections_H
#define LLM_OS_Foundation_Collections_H
#include "llm/base.h"
...
namespace llm::impl
{
    template <typename D, typename T> LLM_IMPL_AUTO(llm::OS::Foundation::Collections::IIterator<T>) consume_Windows_Foundation_Collections_IIterable<D, T>::First() const
    {
        void* llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IIterable<T>)->First(&llm_impl_result));
        return llm::OS::Foundation::Collections::IIterator<T>{ llm_impl_result, take_ownership_from_abi };
    }
    template <typename D, typename T> LLM_IMPL_AUTO(T) consume_Windows_Foundation_Collections_IIterator<D, T>::Current() const
    {
        T llm_impl_result{ empty_value<T>() };
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IIterator<T>)->get_Current(put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(bool) consume_Windows_Foundation_Collections_IIterator<D, T>::HasCurrent() const
    {
        bool llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IIterator<T>)->get_HasCurrent(&llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(bool) consume_Windows_Foundation_Collections_IIterator<D, T>::MoveNext() const
    {
        bool llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IIterator<T>)->MoveNext(&llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(uint32_t) consume_Windows_Foundation_Collections_IIterator<D, T>::GetMany(array_view<T> items) const
    {
        uint32_t llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IIterator<T>)->GetMany(items.size(), put_abi(items), &llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(K) consume_Windows_Foundation_Collections_IKeyValuePair<D, K, V>::Key() const
    {
        K llm_impl_result{ empty_value<K>() };
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IKeyValuePair<K, V>)->get_Key(put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(V) consume_Windows_Foundation_Collections_IKeyValuePair<D, K, V>::Value() const
    {
        V llm_impl_result{ empty_value<V>() };
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IKeyValuePair<K, V>)->get_Value(put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename K> LLM_IMPL_AUTO(llm::OS::Foundation::Collections::CollectionChange) consume_Windows_Foundation_Collections_IMapChangedEventArgs<D, K>::CollectionChange() const
    {
        llm::OS::Foundation::Collections::CollectionChange llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMapChangedEventArgs<K>)->get_CollectionChange(reinterpret_cast<int32_t*>(&llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename K> LLM_IMPL_AUTO(K) consume_Windows_Foundation_Collections_IMapChangedEventArgs<D, K>::Key() const
    {
        K llm_impl_result{ empty_value<K>() };
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMapChangedEventArgs<K>)->get_Key(put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(V) consume_Windows_Foundation_Collections_IMapView<D, K, V>::Lookup(impl::param_type<K> const& key) const
    {
        V llm_impl_result{ empty_value<V>() };
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMapView<K, V>)->Lookup(impl::bind_in(key), put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(uint32_t) consume_Windows_Foundation_Collections_IMapView<D, K, V>::Size() const
    {
        uint32_t llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMapView<K, V>)->get_Size(&llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(bool) consume_Windows_Foundation_Collections_IMapView<D, K, V>::HasKey(impl::param_type<K> const& key) const
    {
        bool llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMapView<K, V>)->HasKey(impl::bind_in(key), &llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IMapView<D, K, V>::Split(llm::OS::Foundation::Collections::IMapView<K, V>& first, llm::OS::Foundation::Collections::IMapView<K, V>& second) const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMapView<K, V>)->Split(impl::bind_out(first), impl::bind_out(second)));
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(V) consume_Windows_Foundation_Collections_IMap<D, K, V>::Lookup(impl::param_type<K> const& key) const
    {
        V llm_impl_result{ empty_value<V>() };
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMap<K, V>)->Lookup(impl::bind_in(key), put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(uint32_t) consume_Windows_Foundation_Collections_IMap<D, K, V>::Size() const
    {
        uint32_t llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMap<K, V>)->get_Size(&llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(bool) consume_Windows_Foundation_Collections_IMap<D, K, V>::HasKey(impl::param_type<K> const& key) const
    {
        bool llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMap<K, V>)->HasKey(impl::bind_in(key), &llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(llm::OS::Foundation::Collections::IMapView<K, V>) consume_Windows_Foundation_Collections_IMap<D, K, V>::GetView() const
    {
        void* llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMap<K, V>)->GetView(&llm_impl_result));
        return llm::OS::Foundation::Collections::IMapView<K, V>{ llm_impl_result, take_ownership_from_abi };
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(bool) consume_Windows_Foundation_Collections_IMap<D, K, V>::Insert(impl::param_type<K> const& key, impl::param_type<V> const& value) const
    {
        bool llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMap<K, V>)->Insert(impl::bind_in(key), impl::bind_in(value), &llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IMap<D, K, V>::Remove(impl::param_type<K> const& key) const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMap<K, V>)->Remove(impl::bind_in(key)));
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IMap<D, K, V>::Clear() const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IMap<K, V>)->Clear());
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(llm::event_token) consume_Windows_Foundation_Collections_IObservableMap<D, K, V>::MapChanged(llm::OS::Foundation::Collections::MapChangedEventHandler<K, V> const& vhnd) const
    {
        llm::event_token llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IObservableMap<K, V>)->add_MapChanged(*(void**)(&vhnd), put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename K, typename V> typename consume_Windows_Foundation_Collections_IObservableMap<D, K, V>::MapChanged_revoker consume_Windows_Foundation_Collections_IObservableMap<D, K, V>::MapChanged(auto_revoke_t, llm::OS::Foundation::Collections::MapChangedEventHandler<K, V> const& vhnd) const
    {
        return impl::make_event_revoker<D, MapChanged_revoker>(this, MapChanged(vhnd));
    }
    template <typename D, typename K, typename V> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IObservableMap<D, K, V>::MapChanged(llm::event_token const& token) const noexcept
    {
        LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IObservableMap<K, V>)->remove_MapChanged(impl::bind_in(token));
    }
    template <typename D, typename T> LLM_IMPL_AUTO(llm::event_token) consume_Windows_Foundation_Collections_IObservableVector<D, T>::VectorChanged(llm::OS::Foundation::Collections::VectorChangedEventHandler<T> const& vhnd) const
    {
        llm::event_token llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IObservableVector<T>)->add_VectorChanged(*(void**)(&vhnd), put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename T> typename consume_Windows_Foundation_Collections_IObservableVector<D, T>::VectorChanged_revoker consume_Windows_Foundation_Collections_IObservableVector<D, T>::VectorChanged(auto_revoke_t, llm::OS::Foundation::Collections::VectorChangedEventHandler<T> const& vhnd) const
    {
        return impl::make_event_revoker<D, VectorChanged_revoker>(this, VectorChanged(vhnd));
    }
    template <typename D, typename T> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IObservableVector<D, T>::VectorChanged(llm::event_token const& token) const noexcept
    {
        LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IObservableVector<T>)->remove_VectorChanged(impl::bind_in(token));
    }
    template <typename D> LLM_IMPL_AUTO(llm::OS::Foundation::Collections::CollectionChange) consume_Windows_Foundation_Collections_IVectorChangedEventArgs<D>::CollectionChange() const
    {
        llm::OS::Foundation::Collections::CollectionChange value{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVectorChangedEventArgs)->get_CollectionChange(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> LLM_IMPL_AUTO(uint32_t) consume_Windows_Foundation_Collections_IVectorChangedEventArgs<D>::Index() const
    {
        uint32_t value{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVectorChangedEventArgs)->get_Index(&value));
        return value;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(T) consume_Windows_Foundation_Collections_IVectorView<D, T>::GetAt(uint32_t index) const
    {
        T llm_impl_result{ empty_value<T>() };
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVectorView<T>)->GetAt(index, put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(uint32_t) consume_Windows_Foundation_Collections_IVectorView<D, T>::Size() const
    {
        uint32_t llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVectorView<T>)->get_Size(&llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(bool) consume_Windows_Foundation_Collections_IVectorView<D, T>::IndexOf(impl::param_type<T> const& value, uint32_t& index) const
    {
        bool llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVectorView<T>)->IndexOf(impl::bind_in(value), &index, &llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(uint32_t) consume_Windows_Foundation_Collections_IVectorView<D, T>::GetMany(uint32_t startIndex, array_view<T> items) const
    {
        uint32_t llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVectorView<T>)->GetMany(startIndex, items.size(), put_abi(items), &llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(T) consume_Windows_Foundation_Collections_IVector<D, T>::GetAt(uint32_t index) const
    {
        T llm_impl_result{ empty_value<T>() };
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->GetAt(index, put_abi(llm_impl_result)));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(uint32_t) consume_Windows_Foundation_Collections_IVector<D, T>::Size() const
    {
        uint32_t llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->get_Size(&llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(llm::OS::Foundation::Collections::IVectorView<T>) consume_Windows_Foundation_Collections_IVector<D, T>::GetView() const
    {
        void* llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->GetView(&llm_impl_result));
        return llm::OS::Foundation::Collections::IVectorView<T>{ llm_impl_result, take_ownership_from_abi };
    }
    template <typename D, typename T> LLM_IMPL_AUTO(bool) consume_Windows_Foundation_Collections_IVector<D, T>::IndexOf(impl::param_type<T> const& value, uint32_t& index) const
    {
        bool llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->IndexOf(impl::bind_in(value), &index, &llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IVector<D, T>::SetAt(uint32_t index, impl::param_type<T> const& value) const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->SetAt(index, impl::bind_in(value)));
    }
    template <typename D, typename T> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IVector<D, T>::InsertAt(uint32_t index, impl::param_type<T> const& value) const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->InsertAt(index, impl::bind_in(value)));
    }
    template <typename D, typename T> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IVector<D, T>::RemoveAt(uint32_t index) const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->RemoveAt(index));
    }
    template <typename D, typename T> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IVector<D, T>::Append(impl::param_type<T> const& value) const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->Append(impl::bind_in(value)));
    }
    template <typename D, typename T> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IVector<D, T>::RemoveAtEnd() const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->RemoveAtEnd());
    }
    template <typename D, typename T> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IVector<D, T>::Clear() const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->Clear());
    }
    template <typename D, typename T> LLM_IMPL_AUTO(uint32_t) consume_Windows_Foundation_Collections_IVector<D, T>::GetMany(uint32_t startIndex, array_view<T> items) const
    {
        uint32_t llm_impl_result{};
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->GetMany(startIndex, items.size(), put_abi(items), &llm_impl_result));
        return llm_impl_result;
    }
    template <typename D, typename T> LLM_IMPL_AUTO(void) consume_Windows_Foundation_Collections_IVector<D, T>::ReplaceAll(array_view<T const> items) const
    {
        check_hresult(LLM_IMPL_SHIM(llm::OS::Foundation::Collections::IVector<T>)->ReplaceAll(items.size(), get_abi(items)));
    }
    template <typename H, typename K, typename V> struct delegate<llm::OS::Foundation::Collections::MapChangedEventHandler<K, V>, H> final : implements_delegate<llm::OS::Foundation::Collections::MapChangedEventHandler<K, V>, H>
    {
        delegate(H&& handler) : implements_delegate<llm::OS::Foundation::Collections::MapChangedEventHandler<K, V>, H>(std::forward<H>(handler)) {}

        int32_t __stdcall Invoke(void* sender, void* event) noexcept final try
        {
            (*this)(*reinterpret_cast<llm::OS::Foundation::Collections::IObservableMap<K, V> const*>(&sender), *reinterpret_cast<llm::OS::Foundation::Collections::IMapChangedEventArgs<K> const*>(&event));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    template <typename H, typename T> struct delegate<llm::OS::Foundation::Collections::VectorChangedEventHandler<T>, H> final : implements_delegate<llm::OS::Foundation::Collections::VectorChangedEventHandler<T>, H>
    {
        delegate(H&& handler) : implements_delegate<llm::OS::Foundation::Collections::VectorChangedEventHandler<T>, H>(std::forward<H>(handler)) {}

        int32_t __stdcall Invoke(void* sender, void* event) noexcept final try
        {
            (*this)(*reinterpret_cast<llm::OS::Foundation::Collections::IObservableVector<T> const*>(&sender), *reinterpret_cast<llm::OS::Foundation::Collections::IVectorChangedEventArgs const*>(&event));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    template <typename D, typename T>
    struct produce<D, llm::OS::Foundation::Collections::IIterable<T>> : produce_base<D, llm::OS::Foundation::Collections::IIterable<T>>
    {
        int32_t __stdcall First(void** llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<llm::OS::Foundation::Collections::IIterator<T>>(this->shim().First());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    template <typename D, typename T>
    struct produce<D, llm::OS::Foundation::Collections::IIterator<T>> : produce_base<D, llm::OS::Foundation::Collections::IIterator<T>>
    {
        int32_t __stdcall get_Current(arg_out<T> llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<T>(this->shim().Current());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_HasCurrent(bool* llm_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<bool>(this->shim().HasCurrent());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall MoveNext(bool* llm_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<bool>(this->shim().MoveNext());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall GetMany(uint32_t __itemsSize, arg_out<T> items, uint32_t* llm_impl_result) noexcept final try
        {
            zero_abi<T>(items, __itemsSize);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<uint32_t>(this->shim().GetMany(array_view<T>(reinterpret_cast<T*>(items), reinterpret_cast<T*>(items) + __itemsSize)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    template <typename D, typename K, typename V>
    struct produce<D, llm::OS::Foundation::Collections::IKeyValuePair<K, V>> : produce_base<D, llm::OS::Foundation::Collections::IKeyValuePair<K, V>>
    {
        int32_t __stdcall get_Key(arg_out<K> llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<K>(this->shim().Key());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_Value(arg_out<V> llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<V>(this->shim().Value());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    template <typename D, typename K>
    struct produce<D, llm::OS::Foundation::Collections::IMapChangedEventArgs<K>> : produce_base<D, llm::OS::Foundation::Collections::IMapChangedEventArgs<K>>
    {
        int32_t __stdcall get_CollectionChange(int32_t* llm_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<llm::OS::Foundation::Collections::CollectionChange>(this->shim().CollectionChange());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_Key(arg_out<K> llm_impl_result) noexcept final try
    ...
    template <typename D, typename K, typename V>
    struct produce<D, llm::OS::Foundation::Collections::IMapView<K, V>> : produce_base<D, llm::OS::Foundation::Collections::IMapView<K, V>>
    {
        int32_t __stdcall Lookup(arg_in<K> key, arg_out<V> llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<V>(this->shim().Lookup(*reinterpret_cast<K const*>(&key)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_Size(uint32_t* llm_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<uint32_t>(this->shim().Size());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall HasKey(arg_in<K> key, bool* llm_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<bool>(this->shim().HasKey(*reinterpret_cast<K const*>(&key)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall Split(void** first, void** second) noexcept final try
        {
            ...
            clear_abi(second);
            typename D::abi_guard guard(this->shim());
            this->shim().Split(*reinterpret_cast<llm::OS::Foundation::Collections::IMapView<K, V>*>(first), *reinterpret_cast<llm::OS::Foundation::Collections::IMapView<K, V>*>(second));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    template <typename D, typename K, typename V>
    struct produce<D, llm::OS::Foundation::Collections::IMap<K, V>> : produce_base<D, llm::OS::Foundation::Collections::IMap<K, V>>
    {
        int32_t __stdcall Lookup(arg_in<K> key, arg_out<V> llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
        ...
        int32_t __stdcall GetView(void** llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<llm::OS::Foundation::Collections::IMapView<K, V>>(this->shim().GetView());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall Insert(arg_in<K> key, arg_in<V> value, bool* llm_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<bool>(this->shim().Insert(*reinterpret_cast<K const*>(&key), *reinterpret_cast<V const*>(&value)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    template <typename D, typename K, typename V>
    struct produce<D, llm::OS::Foundation::Collections::IObservableMap<K, V>> : produce_base<D, llm::OS::Foundation::Collections::IObservableMap<K, V>>
    {
        int32_t __stdcall add_MapChanged(void* vhnd, llm::event_token* llm_impl_result) noexcept final try
        {
            zero_abi<llm::event_token>(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<llm::event_token>(this->shim().MapChanged(*reinterpret_cast<llm::OS::Foundation::Collections::MapChangedEventHandler<K, V> const*>(&vhnd)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall remove_MapChanged(llm::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
            this->shim().MapChanged(*reinterpret_cast<llm::event_token const*>(&token));
            return 0;
        }
    };
    template <typename D, typename T>
    struct produce<D, llm::OS::Foundation::Collections::IObservableVector<T>> : produce_base<D, llm::OS::Foundation::Collections::IObservableVector<T>>
    {
        int32_t __stdcall add_VectorChanged(void* vhnd, llm::event_token* llm_impl_result) noexcept final try
        {
            zero_abi<llm::event_token>(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<llm::event_token>(this->shim().VectorChanged(*reinterpret_cast<llm::OS::Foundation::Collections::VectorChangedEventHandler<T> const*>(&vhnd)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall remove_VectorChanged(llm::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
            this->shim().VectorChanged(*reinterpret_cast<llm::event_token const*>(&token));
            return 0;
        }
    };
    template <typename D>
    struct produce<D, llm::OS::Foundation::Collections::IPropertySet> : produce_base<D, llm::OS::Foundation::Collections::IPropertySet>
    {
    };
    template <typename D>
    struct produce<D, llm::OS::Foundation::Collections::IVectorChangedEventArgs> : produce_base<D, llm::OS::Foundation::Collections::IVectorChangedEventArgs>
    {
    ...
    template <typename D, typename T>
    struct produce<D, llm::OS::Foundation::Collections::IVectorView<T>> : produce_base<D, llm::OS::Foundation::Collections::IVectorView<T>>
    {
        int32_t __stdcall GetAt(uint32_t index, arg_out<T> llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<T>(this->shim().GetAt(index));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_Size(uint32_t* llm_impl_result) noexcept final try
        ...
        int32_t __stdcall IndexOf(arg_in<T> value, uint32_t* index, bool* llm_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<bool>(this->shim().IndexOf(*reinterpret_cast<T const*>(&value), *index));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall GetMany(uint32_t startIndex, uint32_t __itemsSize, arg_out<T> items, uint32_t* llm_impl_result) noexcept final try
        {
            zero_abi<T>(items, __itemsSize);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<uint32_t>(this->shim().GetMany(startIndex, array_view<T>(reinterpret_cast<T*>(items), reinterpret_cast<T*>(items) + __itemsSize)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    template <typename D, typename T>
    struct produce<D, llm::OS::Foundation::Collections::IVector<T>> : produce_base<D, llm::OS::Foundation::Collections::IVector<T>>
    {
        int32_t __stdcall GetAt(uint32_t index, arg_out<T> llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
        ...
        int32_t __stdcall GetView(void** llm_impl_result) noexcept final try
        {
            clear_abi(llm_impl_result);
            typename D::abi_guard guard(this->shim());
            *llm_impl_result = detach_from<llm::OS::Foundation::Collections::IVectorView<T>>(this->shim().GetView());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall IndexOf(arg_in<T> value, uint32_t* index, bool* llm_impl_result) noexcept final try
...
LLM_EXPORT namespace llm::OS::Foundation::Collections
{
    inline PropertySet::PropertySet() :
        PropertySet(impl::call_factory_cast<PropertySet(*)(llm::OS::Foundation::IActivationFactory const&), PropertySet>([](llm::OS::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<PropertySet>(); }))
    {
    }
    inline StringMap::StringMap() :
        StringMap(impl::call_factory_cast<StringMap(*)(llm::OS::Foundation::IActivationFactory const&), StringMap>([](llm::OS::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<StringMap>(); }))
    {
    }
    inline ValueSet::ValueSet() :
        ValueSet(impl::call_factory_cast<ValueSet(*)(llm::OS::Foundation::IActivationFactory const&), ValueSet>([](llm::OS::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<ValueSet>(); }))
    {
    }
    ...
    template <typename K, typename V> auto MapChangedEventHandler<K, V>::operator()(llm::OS::Foundation::Collections::IObservableMap<K, V> const& sender, llm::OS::Foundation::Collections::IMapChangedEventArgs<K> const& event) const
    {
    ...
    template <typename T> auto VectorChangedEventHandler<T>::operator()(llm::OS::Foundation::Collections::IObservableVector<T> const& sender, llm::OS::Foundation::Collections::IVectorChangedEventArgs const& event) const
    {
...
namespace std
{
    ...
    template<typename T> struct hash<llm::OS::Foundation::Collections::IIterable<T>> : llm::impl::hash_base {};
    template<typename T> struct hash<llm::OS::Foundation::Collections::IIterator<T>> : llm::impl::hash_base {};
    template<typename K, typename V> struct hash<llm::OS::Foundation::Collections::IKeyValuePair<K, V>> : llm::impl::hash_base {};
    template<typename K> struct hash<llm::OS::Foundation::Collections::IMapChangedEventArgs<K>> : llm::impl::hash_base {};
    template<typename K, typename V> struct hash<llm::OS::Foundation::Collections::IMapView<K, V>> : llm::impl::hash_base {};
    template<typename K, typename V> struct hash<llm::OS::Foundation::Collections::IMap<K, V>> : llm::impl::hash_base {};
    template<typename K, typename V> struct hash<llm::OS::Foundation::Collections::IObservableMap<K, V>> : llm::impl::hash_base {};
    template<typename T> struct hash<llm::OS::Foundation::Collections::IObservableVector<T>> : llm::impl::hash_base {};
    template<> struct hash<llm::OS::Foundation::Collections::IPropertySet> : llm::impl::hash_base {};
    template<> struct hash<llm::OS::Foundation::Collections::IVectorChangedEventArgs> : llm::impl::hash_base {};
    template<typename T> struct hash<llm::OS::Foundation::Collections::IVectorView<T>> : llm::impl::hash_base {};
    template<typename T> struct hash<llm::OS::Foundation::Collections::IVector<T>> : llm::impl::hash_base {};
    template<> struct hash<llm::OS::Foundation::Collections::PropertySet> : llm::impl::hash_base {};
    template<> struct hash<llm::OS::Foundation::Collections::StringMap> : llm::impl::hash_base {};
    template<> struct hash<llm::OS::Foundation::Collections::ValueSet> : llm::impl::hash_base {};
#endif
...
LLM_EXPORT namespace llm::param
{
    ...
    struct iterable
    {
        ...
        {
            attach_abi(m_pair.first, llm::get_abi(values));
        }
    ...
    struct async_iterable
    {
        ...
        {
            attach_abi(m_interface, llm::get_abi(values));
        }
...
{
    template<typename K, typename V>
    struct tuple_size<llm::OS::Foundation::Collections::IKeyValuePair<K, V>>
        : integral_constant<size_t, 2>
    {
    };

    template<size_t Idx, typename K, typename V>
    struct tuple_element<Idx, llm::OS::Foundation::Collections::IKeyValuePair<K, V>>
    {
...
namespace llm::OS::Foundation::Collections
{
    template<size_t Idx, typename K, typename V>
