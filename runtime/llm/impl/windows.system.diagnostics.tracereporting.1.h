...
#pragma once
#ifndef LLM_OS_System_Diagnostics_TraceReporting_1_H
#define LLM_OS_System_Diagnostics_TraceReporting_1_H
#include "llm/impl/Windows.System.Diagnostics.TraceReporting.0.h"
LLM_EXPORT namespace llm:OS::System::Diagnostics::TraceReporting
{
        ...
        impl::consume_t<IPlatformDiagnosticActionsStatics>
    {
        ...
        IPlatformDiagnosticActionsStatics(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<IPlatformDiagnosticTraceInfo>
    {
        ...
        IPlatformDiagnosticTraceInfo(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<IPlatformDiagnosticTraceRuntimeInfo>
    {
        ...
        IPlatformDiagnosticTraceRuntimeInfo(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
}
#endif
