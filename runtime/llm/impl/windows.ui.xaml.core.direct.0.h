...
#pragma once
#ifndef LLM_OS_UI_Xaml_Core_Direct_0_H
#define LLM_OS_UI_Xaml_Core_Direct_0_H
...
namespace llm::impl
{
    template <> struct category<llm::OS::UI::Xaml::Core::Direct::IXamlDirect>{ using type = interface_category; };
    template <> struct category<llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject>{ using type = interface_category; };
    template <> struct category<llm::OS::UI::Xaml::Core::Direct::IXamlDirectStatics>{ using type = interface_category; };
    template <> struct category<llm::OS::UI::Xaml::Core::Direct::XamlDirect>{ using type = class_category; };
    template <> struct category<llm::OS::UI::Xaml::Core::Direct::XamlEventIndex>{ using type = enum_category; };
    template <> struct category<llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex>{ using type = enum_category; };
    template <> struct category<llm::OS::UI::Xaml::Core::Direct::XamlTypeIndex>{ using type = enum_category; };
    template <> inline constexpr auto& name_v<llm::OS::UI::Xaml::Core::Direct::XamlDirect> = L"Windows.UI.Xaml.Core.Direct.XamlDirect";
    template <> inline constexpr auto& name_v<llm::OS::UI::Xaml::Core::Direct::XamlEventIndex> = L"Windows.UI.Xaml.Core.Direct.XamlEventIndex";
    template <> inline constexpr auto& name_v<llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex> = L"Windows.UI.Xaml.Core.Direct.XamlPropertyIndex";
    template <> inline constexpr auto& name_v<llm::OS::UI::Xaml::Core::Direct::XamlTypeIndex> = L"Windows.UI.Xaml.Core.Direct.XamlTypeIndex";
    template <> inline constexpr auto& name_v<llm::OS::UI::Xaml::Core::Direct::IXamlDirect> = L"Windows.UI.Xaml.Core.Direct.IXamlDirect";
    template <> inline constexpr auto& name_v<llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject> = L"Windows.UI.Xaml.Core.Direct.IXamlDirectObject";
    template <> inline constexpr auto& name_v<llm::OS::UI::Xaml::Core::Direct::IXamlDirectStatics> = L"Windows.UI.Xaml.Core.Direct.IXamlDirectStatics";
    template <> inline constexpr guid guid_v<llm::OS::UI::Xaml::Core::Direct::IXamlDirect>{ 0x5FFA1295,0xADD2,0x590F,{ 0xA0,0x51,0x70,0x98,0x9B,0x86,0x6A,0xDE } }; // 5FFA1295-ADD2-590F-A051-70989B866ADE
    template <> inline constexpr guid guid_v<llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject>{ 0x10614A82,0xCEE4,0x4645,{ 0xBA,0x25,0xD0,0x71,0xCE,0x77,0x83,0x55 } }; // 10614A82-CEE4-4645-BA25-D071CE778355
    template <> inline constexpr guid guid_v<llm::OS::UI::Xaml::Core::Direct::IXamlDirectStatics>{ 0x321887CC,0x14E4,0x5C6F,{ 0x87,0x8D,0xFB,0xB6,0x04,0xAD,0x7D,0x17 } }; // 321887CC-14E4-5C6F-878D-FBB604AD7D17
    template <> struct default_interface<llm::OS::UI::Xaml::Core::Direct::XamlDirect>{ using type = llm::OS::UI::Xaml::Core::Direct::IXamlDirect; };
    template <> struct abi<llm::OS::UI::Xaml::Core::Direct::IXamlDirect>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall SetPointProperty(void*, int32_t, llm::OS::Foundation::Point) noexcept = 0;
            virtual int32_t __stdcall SetRectProperty(void*, int32_t, llm::OS::Foundation::Rect) noexcept = 0;
            virtual int32_t __stdcall SetSizeProperty(void*, int32_t, llm::OS::Foundation::Size) noexcept = 0;
            ...
            virtual int32_t __stdcall GetPointProperty(void*, int32_t, llm::OS::Foundation::Point*) noexcept = 0;
            virtual int32_t __stdcall GetRectProperty(void*, int32_t, llm::OS::Foundation::Rect*) noexcept = 0;
            virtual int32_t __stdcall GetSizeProperty(void*, int32_t, llm::OS::Foundation::Size*) noexcept = 0;
    ...
    template <> struct abi<llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
        };
    };
    template <> struct abi<llm::OS::UI::Xaml::Core::Direct::IXamlDirectStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        WINRT_IMPL_AUTO(llm::OS::Foundation::IInspectable) GetObject(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject) GetXamlDirectObject(llm::OS::Foundation::IInspectable const& object) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject) CreateInstance(llm::OS::UI::Xaml::Core::Direct::XamlTypeIndex const& typeIndex) const;
        WINRT_IMPL_AUTO(void) SetObjectProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::Foundation::IInspectable const& value) const;
        WINRT_IMPL_AUTO(void) SetXamlDirectObjectProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& value) const;
        WINRT_IMPL_AUTO(void) SetBooleanProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, bool value) const;
        WINRT_IMPL_AUTO(void) SetDoubleProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, double value) const;
        WINRT_IMPL_AUTO(void) SetInt32Property(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, int32_t value) const;
        WINRT_IMPL_AUTO(void) SetStringProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, param::hstring const& value) const;
        WINRT_IMPL_AUTO(void) SetDateTimeProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::Foundation::DateTime const& value) const;
        WINRT_IMPL_AUTO(void) SetPointProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::Foundation::Point const& value) const;
        WINRT_IMPL_AUTO(void) SetRectProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::Foundation::Rect const& value) const;
        WINRT_IMPL_AUTO(void) SetSizeProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::Foundation::Size const& value) const;
        WINRT_IMPL_AUTO(void) SetTimeSpanProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::Foundation::TimeSpan const& value) const;
        WINRT_IMPL_AUTO(void) SetColorProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::UI::Color const& value) const;
        WINRT_IMPL_AUTO(void) SetCornerRadiusProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::UI::Xaml::CornerRadius const& value) const;
        WINRT_IMPL_AUTO(void) SetDurationProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::UI::Xaml::Duration const& value) const;
        WINRT_IMPL_AUTO(void) SetGridLengthProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::UI::Xaml::GridLength const& value) const;
        WINRT_IMPL_AUTO(void) SetThicknessProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::UI::Xaml::Thickness const& value) const;
        WINRT_IMPL_AUTO(void) SetMatrixProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::UI::Xaml::Media::Matrix const& value) const;
        WINRT_IMPL_AUTO(void) SetMatrix3DProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, llm::OS::UI::Xaml::Media::Media3D::Matrix3D const& value) const;
        WINRT_IMPL_AUTO(void) SetEnumProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, uint32_t value) const;
        WINRT_IMPL_AUTO(llm::OS::Foundation::IInspectable) GetObjectProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject) GetXamlDirectObjectProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(bool) GetBooleanProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(double) GetDoubleProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(int32_t) GetInt32Property(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(hstring) GetStringProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::Foundation::DateTime) GetDateTimeProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::Foundation::Point) GetPointProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::Foundation::Rect) GetRectProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::Foundation::Size) GetSizeProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::Foundation::TimeSpan) GetTimeSpanProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Color) GetColorProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::CornerRadius) GetCornerRadiusProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::Duration) GetDurationProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::GridLength) GetGridLengthProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::Thickness) GetThicknessProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::Media::Matrix) GetMatrixProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::Media::Media3D::Matrix3D) GetMatrix3DProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(uint32_t) GetEnumProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(void) ClearProperty(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(uint32_t) GetCollectionCount(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject) const;
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject) GetXamlDirectObjectFromCollectionAt(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, uint32_t index) const;
        WINRT_IMPL_AUTO(void) AddToCollection(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& value) const;
        WINRT_IMPL_AUTO(void) InsertIntoCollectionAt(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, uint32_t index, llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& value) const;
        WINRT_IMPL_AUTO(bool) RemoveFromCollection(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& value) const;
        WINRT_IMPL_AUTO(void) RemoveFromCollectionAt(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, uint32_t index) const;
        WINRT_IMPL_AUTO(void) ClearCollection(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject) const;
        WINRT_IMPL_AUTO(void) AddEventHandler(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlEventIndex const& eventIndex, llm::OS::Foundation::IInspectable const& handler) const;
        WINRT_IMPL_AUTO(void) AddEventHandler(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlEventIndex const& eventIndex, llm::OS::Foundation::IInspectable const& handler, bool handledEventsToo) const;
        WINRT_IMPL_AUTO(void) RemoveEventHandler(llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, llm::OS::UI::Xaml::Core::Direct::XamlEventIndex const& eventIndex, llm::OS::Foundation::IInspectable const& handler) const;
    };
    template <> struct consume<llm::OS::UI::Xaml::Core::Direct::IXamlDirect>
    {
    ...
    template <> struct consume<llm::OS::UI::Xaml::Core::Direct::IXamlDirectObject>
    {
    ...
    {
        WINRT_IMPL_AUTO(llm::OS::UI::Xaml::Core::Direct::XamlDirect) GetDefault() const;
    };
    template <> struct consume<llm::OS::UI::Xaml::Core::Direct::IXamlDirectStatics>
    {
