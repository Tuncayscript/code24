...
#pragma once
#ifndef LLM_OS_System_Power_1_H
#define LLM_OS_System_Power_1_H
#include "llm/impl/Windows.System.Power.0.h"
LLM_EXPORT namespace llm:OS::System::Power
{
        ...
        impl::consume_t<IBackgroundEnergyManagerStatics>
    {
        ...
        IBackgroundEnergyManagerStatics(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<IForegroundEnergyManagerStatics>
    {
        ...
        IForegroundEnergyManagerStatics(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<IPowerManagerStatics>
    {
        ...
        IPowerManagerStatics(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
}
#endif
