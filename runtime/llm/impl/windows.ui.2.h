...
#pragma once
#ifndef LLM_OS_UI_2_H
#define LLM_OS_UI_2_H
...
LLM_EXPORT namespace llm:OS::UI
{
    ...
    struct __declspec(empty_bases) ColorHelper : llm:OS::UI::IColorHelper
    {
        ColorHelper(std::nullptr_t) noexcept {}
        ColorHelper(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::UI::IColorHelper(ptr, take_ownership_from_abi) {}
        static auto FromArgb(uint8_t a, uint8_t r, uint8_t g, uint8_t b);
        static auto ToDisplayName(llm:OS::UI::Color const& color);
    };
    struct __declspec(empty_bases) Colors : llm:OS::UI::IColors
    {
        Colors(std::nullptr_t) noexcept {}
        Colors(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::UI::IColors(ptr, take_ownership_from_abi) {}
    ...
    struct __declspec(empty_bases) UIContentRoot : llm:OS::UI::IUIContentRoot
    {
        UIContentRoot(std::nullptr_t) noexcept {}
        UIContentRoot(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::UI::IUIContentRoot(ptr, take_ownership_from_abi) {}
    };
    struct __declspec(empty_bases) UIContext : llm:OS::UI::IUIContext
    {
        UIContext(std::nullptr_t) noexcept {}
        UIContext(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::UI::IUIContext(ptr, take_ownership_from_abi) {}
    };
}
#endif
