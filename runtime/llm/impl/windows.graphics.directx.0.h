...
#pragma once
#ifndef LLM_OS_Graphics_DirectX_0_H
#define LLM_OS_Graphics_DirectX_0_H
...
namespace llm::impl
{
    template <> struct category<llm:OS::Graphics::DirectX::DirectXAlphaMode>{ using type = enum_category; };
    template <> struct category<llm:OS::Graphics::DirectX::DirectXColorSpace>{ using type = enum_category; };
    template <> struct category<llm:OS::Graphics::DirectX::DirectXPixelFormat>{ using type = enum_category; };
    template <> struct category<llm:OS::Graphics::DirectX::DirectXPrimitiveTopology>{ using type = enum_category; };
    template <> inline constexpr auto& name_v<llm:OS::Graphics::DirectX::DirectXAlphaMode> = L"Windows.Graphics.DirectX.DirectXAlphaMode";
    template <> inline constexpr auto& name_v<llm:OS::Graphics::DirectX::DirectXColorSpace> = L"Windows.Graphics.DirectX.DirectXColorSpace";
    template <> inline constexpr auto& name_v<llm:OS::Graphics::DirectX::DirectXPixelFormat> = L"Windows.Graphics.DirectX.DirectXPixelFormat";
    template <> inline constexpr auto& name_v<llm:OS::Graphics::DirectX::DirectXPrimitiveTopology> = L"Windows.Graphics.DirectX.DirectXPrimitiveTopology";
}
#endif
