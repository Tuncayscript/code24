...
#pragma once
#ifndef LLM_OS_Security_Authentication_Identity_1_H
#define LLM_OS_Security_Authentication_Identity_1_H
#include "llm/impl/Windows.Security.Authentication.Identity.0.h"
LLM_EXPORT namespace llm:OS::Security::Authentication::Identity
{
        ...
        impl::consume_t<IEnterpriseKeyCredentialRegistrationInfo>
    {
        ...
        IEnterpriseKeyCredentialRegistrationInfo(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<IEnterpriseKeyCredentialRegistrationManager>
    {
        ...
        IEnterpriseKeyCredentialRegistrationManager(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<IEnterpriseKeyCredentialRegistrationManagerStatics>
    {
        ...
        IEnterpriseKeyCredentialRegistrationManagerStatics(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
}
#endif
