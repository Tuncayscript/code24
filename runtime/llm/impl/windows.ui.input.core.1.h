...
#pragma once
#ifndef LLM_OS_UI_Input_Core_1_H
#define LLM_OS_UI_Input_Core_1_H
#include "llm/impl/Windows.UI.Input.Core.0.h"
LLM_EXPORT namespace llm:OS::UI::Input::Core
{
        ...
        impl::consume_t<IRadialControllerIndependentInputSource>
    {
        ...
        IRadialControllerIndependentInputSource(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<IRadialControllerIndependentInputSource2>
    {
        ...
        IRadialControllerIndependentInputSource2(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<IRadialControllerIndependentInputSourceStatics>
    {
        ...
        IRadialControllerIndependentInputSourceStatics(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
}
#endif
