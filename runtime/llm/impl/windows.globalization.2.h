...
#pragma once
#ifndef LLM_OS_Globalization_2_H
#define LLM_OS_Globalization_2_H
...
LLM_EXPORT namespace llm:OS::Globalization
{
    struct ApplicationLanguages
    {
        ...
        static auto GetLanguagesForUser(llm:OS::System::User const& user);
    };
    struct __declspec(empty_bases) Calendar : llm:OS::Globalization::ICalendar,
        impl::require<Calendar, llm:OS::Globalization::ITimeZoneOnCalendar>
    {
        Calendar(std::nullptr_t) noexcept {}
        Calendar(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Globalization::ICalendar(ptr, take_ownership_from_abi) {}
        Calendar();
    ...
    struct __declspec(empty_bases) CurrencyAmount : llm:OS::Globalization::ICurrencyAmount
    {
        CurrencyAmount(std::nullptr_t) noexcept {}
        CurrencyAmount(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Globalization::ICurrencyAmount(ptr, take_ownership_from_abi) {}
    ...
    struct __declspec(empty_bases) GeographicRegion : llm:OS::Globalization::IGeographicRegion
    {
        GeographicRegion(std::nullptr_t) noexcept {}
        GeographicRegion(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Globalization::IGeographicRegion(ptr, take_ownership_from_abi) {}
        GeographicRegion();
    ...
    struct __declspec(empty_bases) JapanesePhoneme : llm:OS::Globalization::IJapanesePhoneme
    {
        JapanesePhoneme(std::nullptr_t) noexcept {}
        JapanesePhoneme(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Globalization::IJapanesePhoneme(ptr, take_ownership_from_abi) {}
    };
    ...
    struct __declspec(empty_bases) Language : llm:OS::Globalization::ILanguage,
        impl::require<Language, llm:OS::Globalization::ILanguageExtensionSubtags, llm:OS::Globalization::ILanguage2, llm:OS::Globalization::ILanguage3>
    {
        Language(std::nullptr_t) noexcept {}
        Language(void* ptr, take_ownership_from_abi_t) noexcept : llm:OS::Globalization::ILanguage(ptr, take_ownership_from_abi) {}
