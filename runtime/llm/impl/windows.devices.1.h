...
#pragma once
#ifndef LLM_OS_Devices_1_H
#define LLM_OS_Devices_1_H
#include "llm/impl/Windows.Devices.0.h"
LLM_EXPORT namespace llm::OS::Devices
{
        ...
        impl::consume_t<ILowLevelDevicesAggregateProvider>
    {
        ...
        ILowLevelDevicesAggregateProvider(void* ptr, take_ownership_from_abi_t) noexcept : llm::OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<ILowLevelDevicesAggregateProviderFactory>
    {
        ...
        ILowLevelDevicesAggregateProviderFactory(void* ptr, take_ownership_from_abi_t) noexcept : llm::OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<ILowLevelDevicesController>
    {
        ...
        ILowLevelDevicesController(void* ptr, take_ownership_from_abi_t) noexcept : llm::OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
        ...
        impl::consume_t<ILowLevelDevicesControllerStatics>
    {
        ...
        ILowLevelDevicesControllerStatics(void* ptr, take_ownership_from_abi_t) noexcept : llm::OS::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
}
#endif
