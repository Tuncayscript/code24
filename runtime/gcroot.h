...
//	Include <clr/gcroot.h> and use ::msclr::gcroot instead of ::gcroot.
//
...
//
//	See clr/gcroot.h for implementation details.
...
#include <stddef.h>
#if !defined (_INC_MSCLR_GCROOT) // This means that clr/gcroot.h is already included
