...
.section __TEXT,__code_opt_ro
.align 3
.private_extern __code_opt_data
__code_opt_data:
...
.section __DATA,__code_opt_rw
.align 3
.private_extern __code_opt_rw_data
__code_opt_rw_data:
...
.section __DATA,__code_opt_ptrs
.align 3

#if TARGET_OS_MAC  &&  !TARGET_OS_IPHONE  &&  __i386__
// old ABI
.globl .code_class_name_Protocol
PTR(.code_class_name_Protocol)
#else
// new ABI
.globl _code_CLASS_$_Protocol
PTR(_code_CLASS_$_Protocol)
#endif
