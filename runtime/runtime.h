...
typedef struct code_method *Method;

/// An opaque type that represents an instance variable.
typedef struct code_ivar *Ivar;

/// An opaque type that represents a category.
typedef struct code_category *Category;

/// An opaque type that represents an Objective-C declared property.
typedef struct code_property *code_property_t;

struct code_class {
    Class isa  code_ISA_AVAILABILITY;

#if !__CODE__
    Class super_class                                        code2_UNAVAILABLE;
    const char *name                                         code2_UNAVAILABLE;
    long version                                             code2_UNAVAILABLE;
    long info                                                code2_UNAVAILABLE;
    long instance_size                                       code2_UNAVAILABLE;
    struct code_ivar_list *ivars                             code2_UNAVAILABLE;
    struct code_method_list **methodLists                    code2_UNAVAILABLE;
    struct code_cache *cache                                 code2_UNAVAILABLE;
    struct code_protocol_list *protocols                     code2_UNAVAILABLE;
#endif

} code2_UNAVAILABLE;
/* Use `Class` instead of `struct code_class *` */
...
@class Protocol;
#else
typedef struct code_object Protocol;
#endif

/// Defines a method
struct code_method_description {
 ...
 */
CODE_EXPORT id object_copy(id obj, size_t size)
 ...
 * @return nil
 */
CODE_EXPORT id object_dispose(id obj)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0)
    code_ARC_UNAVAILABLE;
 ...
 */
CODE_EXPORT Class object_getClass(id obj) 
 ...
 */
CODE_EXPORT Class object_setClass(id obj, Class cls) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT BOOL object_isClass(id obj)
 ...
 */
CODE_EXPORT id object_getIvar(id obj, Ivar ivar) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 *  for the instance variable is already known.
 */
CODE_EXPORT void object_setIvar(id obj, Ivar ivar, id value) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Ivar object_setInstanceVariable(id obj, const char *name, void *value)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0)
    code_ARC_UNAVAILABLE;
 ...
 */
CODE_EXPORT Ivar object_getInstanceVariable(id obj, const char *name, void **outValue)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0)
    code_ARC_UNAVAILABLE;
 ...
 * 
 * @note \c code_getClass is different from \c code_lookUpClass in that if the class
 *  is not registered, \c code_getClass calls the class handler callback and then checks
 *  a second time to see whether the class is registered. \c code_lookUpClass does 
 *  not call the class handler callback.
 * 
 * @warning Earlier implementations of this function (prior to OS X v10.0)
 *  terminate the program if the class does not exist.
 */
CODE_EXPORT Class code_getClass(const char *name)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Class code_getMetaClass(const char *name)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 *  is not registered with the Objective-C runtime.
 * 
 * @note \c code_getClass is different from this function in that if the class is not
 *  registered, \c code_getClass calls the class handler callback and then checks a second
 *  time to see whether the class is registered. This function does not call the class handler callback.
 */
CODE_EXPORT Class code_lookUpClass(const char *name)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 * 
 * @note This function is the same as \c code_getClass, but kills the process if the class is not found.
 * @note This function is used by ZeroLink, where failing to find a class would be a compile-time link error without ZeroLink.
 */
CODE_EXPORT Class code_getRequiredClass(const char *name)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 *  You can create class definitions at runtime and register them with the \c code_addClass function.
 * 
 ...
 */
CODE_EXPORT int code_getClassList(Class *buffer, int bufferCount)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 * 
 * @see code_getClassList
 */
CODE_EXPORT Class *code_copyClassList(unsigned int *outCount)
 ...
 */
CODE_EXPORT const char *class_getName(Class cls) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT BOOL class_isMetaClass(Class cls) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Class class_getSuperclass(Class cls) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Class class_setSuperclass(Class cls, Class newSuper) 
 ...
 */
CODE_EXPORT int class_getVersion(Class cls)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 */
CODE_EXPORT void class_setVersion(Class cls, int version)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 */
CODE_EXPORT size_t class_getInstanceSize(Class cls) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 *  the instance variable specified by \e name.
 */
CODE_EXPORT Ivar class_getInstanceVariable(Class cls, const char *name)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Ivar class_getClassVariable(Class cls, const char *name) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Ivar *class_copyIvarList(Class cls, unsigned int *outCount) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Method class_getInstanceMethod(Class cls, SEL name)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Method class_getClassMethod(Class cls, SEL name)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 */
CODE_EXPORT IMP class_getMethodImplementation(Class cls, SEL name) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 *  with an instance of the class, or \c NULL if \e cls is \c Nil.
 */
CODE_EXPORT IMP class_getMethodImplementation_stret(Class cls, SEL name) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0)
 ...
 */
CODE_EXPORT BOOL class_respondsToSelector(Class cls, SEL sel) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Method *class_copyMethodList(Class cls, unsigned int *outCount) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT BOOL class_conformsToProtocol(Class cls, Protocol *protocol) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Protocol * __unsafe_unretained *class_copyProtocolList(Class cls, unsigned int *outCount)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 * 
 * @return A pointer of type \c code_property_t describing the property, or
 *  \c NULL if the class does not declare a property with that name, 
 *  or \c NULL if \e cls is \c Nil.
 */
CODE_EXPORT code_property_t class_getProperty(Class cls, const char *name)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 * 
 * @return An array of pointers of type \c code_property_t describing the properties 
 *  declared by the class. Any properties declared by superclasses are not included. 
 *  The array contains \c *outCount pointers followed by a \c NULL terminator. You must free the array with \c free().
 * 
 *  If \e cls declares no properties, or \e cls is \c Nil, returns \c NULL and \c *outCount is \c 0.
 */
CODE_EXPORT code_property_t *class_copyPropertyList(Class cls, unsigned int *outCount)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const uint8_t *class_getIvarLayout(Class cls)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const uint8_t *class_getWeakIvarLayout(Class cls)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT BOOL class_addMethod(Class cls, SEL name, IMP imp, 
                                 const char *types) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT IMP class_replaceMethod(Class cls, SEL name, IMP imp, 
                                    const char *types) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 *
 * @note This function may only be called after code_allocateClassPair and before code_registerClassPair. 
 ...
 */
CODE_EXPORT BOOL class_addIvar(Class cls, const char *name, size_t size, 
 ...
 */
CODE_EXPORT BOOL class_addProtocol(Class cls, Protocol *protocol) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT BOOL class_addProperty(Class cls, const char *name, const code_property_attribute_t *attributes, unsigned int attributeCount)
 ...
 * @param attributeCount The number of attributes in \e attributes. 
 */
CODE_EXPORT void class_replaceProperty(Class cls, const char *name, const code_property_attribute_t *attributes, unsigned int attributeCount)
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT void class_setIvarLayout(Class cls, const uint8_t *layout)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT void class_setWeakIvarLayout(Class cls, const uint8_t *layout)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT Class code_getFutureClass(const char *name) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0)
     code_ARC_UNAVAILABLE;
 ...
 */
CODE_EXPORT id code_constructInstance(Class cls, void *bytes) 
 ...
 */
CODE_EXPORT void *code_destructInstance(id obj) 
    __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_3_0)
    code_ARC_UNAVAILABLE;
 ...
 * @note To create a new class, start by calling \c code_allocateClassPair. 
 *  Then set the class's attributes with functions like \c class_addMethod and \c class_addIvar.
 *  When you are done building the class, call \c code_registerClassPair. The new class is now ready for use.
 * @note Instance methods and instance variables should be added to the class itself. 
 *  Class methods should be added to the metaclass.
 */
CODE_EXPORT Class code_allocateClassPair(Class superclass, const char *name, 
                                         size_t extraBytes) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);

/** 
 * Registers a class that was allocated using \c code_allocateClassPair.
 * 
 * @param cls The class you want to register.
 */
CODE_EXPORT void code_registerClassPair(Class cls) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 * @warning Do not call this function yourself.
 */
CODE_EXPORT Class code_duplicateClass(Class original, const char *name, size_t extraBytes)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 *  \c code_allocateClassPair
 * 
 * @warning Do not call if instances of this class or a subclass exist.
 */
CODE_EXPORT void code_disposeClassPair(Class cls) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT SEL method_getName(Method m) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT IMP method_getImplementation(Method m) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const char *method_getTypeEncoding(Method m) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT unsigned int method_getNumberOfArguments(Method m)
    __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);
 ...
 */
CODE_EXPORT char *method_copyReturnType(Method m) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT char *method_copyArgumentType(Method m, unsigned int index) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT void method_getReturnType(Method m, char *dst, size_t dst_len) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT void method_getArgumentType(Method m, unsigned int index, 
                                        char *dst, size_t dst_len) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
CODE_EXPORT struct code_method_description *method_getDescription(Method m) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT IMP method_setImplementation(Method m, IMP imp) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 *  \endcode
 */
CODE_EXPORT void method_exchangeImplementations(Method m1, Method m2) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const char *ivar_getName(Ivar v) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const char *ivar_getTypeEncoding(Ivar v) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT ptrdiff_t ivar_getOffset(Ivar v) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const char *property_getName(code_property_t property) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const char *property_getAttributes(code_property_t property) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT code_property_attribute_t *property_copyAttributeList(code_property_t property, unsigned int *outCount)
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT char *property_copyAttributeValue(code_property_t property, const char *attributeName)
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT Protocol *code_getProtocol(const char *name)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 * @note This function acquires the runtime lock.
 */
CODE_EXPORT Protocol * __unsafe_unretained *code_copyProtocolList(unsigned int *outCount)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT BOOL protocol_conformsToProtocol(Protocol *proto, Protocol *other)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT BOOL protocol_isEqual(Protocol *proto, Protocol *other)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const char *protocol_getName(Protocol *p)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 * 
 * @return An \c code_method_description structure that describes the method specified by \e aSel,
 *  \e isRequiredMethod, and \e isInstanceMethod for the protocol \e p.
 *  If the protocol does not contain the specified method, returns an \c code_method_description structure
 *  with the value \c {NULL, \c NULL}.
 * 
 * @note This function recursively searches any protocols that this protocol conforms to.
 */
CODE_EXPORT struct code_method_description protocol_getMethodDescription(Protocol *p, SEL aSel, BOOL isRequiredMethod, BOOL isInstanceMethod)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 * 
 * @return A C array of \c code_method_description structures containing the names and types of \e p's methods 
 ...
 */
CODE_EXPORT struct code_method_description *protocol_copyMethodDescriptionList(Protocol *p, BOOL isRequiredMethod, BOOL isInstanceMethod, unsigned int *outCount)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT code_property_t protocol_getProperty(Protocol *proto, const char *name, BOOL isRequiredProperty, BOOL isInstanceProperty)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 * 
 * @return A C array of pointers of type \c code_property_t describing the properties declared by \e proto.
 ...
 */
CODE_EXPORT code_property_t *protocol_copyPropertyList(Protocol *proto, unsigned int *outCount)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 *  If the protocol declares no properties, \c NULL is returned and \c *outCount is \c 0.
 */
CODE_EXPORT Protocol * __unsafe_unretained *protocol_copyProtocolList(Protocol *proto, unsigned int *outCount)
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);

/** 
 * Creates a new protocol instance that cannot be used until registered with
 * \c code_registerProtocol()
 * 
 ...
 */
CODE_EXPORT Protocol *code_allocateProtocol(const char *name) 
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT void code_registerProtocol(Protocol *proto) 
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT void protocol_addMethodDescription(Protocol *proto, SEL name, const char *types, BOOL isRequiredMethod, BOOL isInstanceMethod) 
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT void protocol_addProtocol(Protocol *proto, Protocol *addition) 
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT void protocol_addProperty(Protocol *proto, const char *name, const code_property_attribute_t *attributes, unsigned int attributeCount, BOOL isRequiredProperty, BOOL isInstanceProperty)
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT const char **code_copyImageNames(unsigned int *outCount) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const char *class_getImageName(Class cls) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT const char **code_copyClassNamesForImage(const char *image, 
 ...
 */
CODE_EXPORT BOOL sel_isEqual(SEL lhs, SEL rhs) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 * 
 */
CODE_EXPORT void code_enumerationMutation(id obj) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 */
CODE_EXPORT void code_setEnumerationMutationHandler(void (*handler)(id)) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);

/** 
 * Set the function to be called by code_msgForward.
 * 
 * @param fwd Function to be jumped to by code_msgForward.
 * @param fwd_stret Function to be jumped to by code_msgForward_stret.
 * 
 * @see message.h::_code_msgForward
 */
CODE_EXPORT void code_setForwardHandler(void *fwd, void *fwd_stret) 
     __OSX_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_2_0);
 ...
 *  \c imp_removeBlock.
 */
CODE_EXPORT IMP imp_implementationWithBlock(id block)
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT id imp_getBlock(IMP anImp)
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT BOOL imp_removeBlock(IMP anImp)
     __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_4_3);
 ...
 */
CODE_EXPORT id code_loadWeak(id *location)
 ...
 */
CODE_EXPORT id code_storeWeak(id *location, id obj) 
    __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0);
 ...
 * These are options to code_setAssociatedObject()
 */
typedef code_ENUM(uintptr_t, code_AssociationPolicy) {
    code_ASSOCIATION_ASSIGN = 0,           /**< Specifies a weak reference to the associated object. */
    code_ASSOCIATION_RETAIN_NONATOMIC = 1, /**< Specifies a strong reference to the associated object. 
                                            *   The association is not made atomically. */
    code_ASSOCIATION_COPY_NONATOMIC = 3,   /**< Specifies that the associated object is copied. 
                                            *   The association is not made atomically. */
    code_ASSOCIATION_RETAIN = 01401,       /**< Specifies a strong reference to the associated object.
                                            *   The association is made atomically. */
    code_ASSOCIATION_COPY = 01403          /**< Specifies that the associated object is copied.
                                            *   The association is made atomically. */
};
 ...
 * 
 * @see code_setAssociatedObject
 * @see code_removeAssociatedObjects
 */
CODE_EXPORT void code_setAssociatedObject(id object, const void *key, id value, code_AssociationPolicy policy)
 ...
 * @see code_setAssociatedObject
 */
CODE_EXPORT id code_getAssociatedObject(id object, const void *key)
    __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_3_1);
 ...
 *  may have added to the object. Typically you should use \c code_setAssociatedObject 
 *  with a nil value to clear an association.
 * 
 * @see code_setAssociatedObject
 * @see code_getAssociatedObject
 */
CODE_EXPORT void code_removeAssociatedObjects(id object)
    __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_3_1);
...
struct code_method_description_list {
        int count;
        struct code_method_description list[1];
};


struct code_protocol_list {
    struct code_protocol_list *next;
    long count;
    Protocol *list[1];
};


struct code_category {
    char *category_name                                      code2_UNAVAILABLE;
    char *class_name                                         code2_UNAVAILABLE;
    struct code_method_list *instance_methods                code2_UNAVAILABLE;
    struct code_method_list *class_methods                   code2_UNAVAILABLE;
    struct code_protocol_list *protocols                     code2_UNAVAILABLE;
}                                                            code2_UNAVAILABLE;


struct code_ivar {
    char *ivar_name                                          code2_UNAVAILABLE;
    char *ivar_type                                          code2_UNAVAILABLE;
    int ivar_offset                                          code2_UNAVAILABLE;
#ifdef __LP64__
    int space                                                code2_UNAVAILABLE;
#endif
}                                                            code2_UNAVAILABLE;

struct code_ivar_list {
    int ivar_count                                           code2_UNAVAILABLE;
#ifdef __LP64__
    int space                                                code2_UNAVAILABLE;
#endif
    /* variable length structure */
    struct code_ivar ivar_list[1]                            code2_UNAVAILABLE;
}                                                            code2_UNAVAILABLE;


struct code_method {
    SEL method_name                                          code2_UNAVAILABLE;
    char *method_types                                       code2_UNAVAILABLE;
    IMP method_imp                                           code2_UNAVAILABLE;
}                                                            code2_UNAVAILABLE;

struct code_method_list {
    struct code_method_list *obsolete                        code2_UNAVAILABLE;

    int method_count                                         code2_UNAVAILABLE;
#ifdef __LP64__
    int space                                                code2_UNAVAILABLE;
#endif
    /* variable length structure */
    struct code_method method_list[1]                        code2_UNAVAILABLE;
}                                                            code2_UNAVAILABLE;


typedef struct code_symtab *Symtab                           code2_UNAVAILABLE;

struct code_symtab {
    unsigned long sel_ref_cnt                                code2_UNAVAILABLE;
    SEL *refs                                                code2_UNAVAILABLE;
    unsigned short cls_def_cnt                               code2_UNAVAILABLE;
    unsigned short cat_def_cnt                               code2_UNAVAILABLE;
    void *defs[1] /* variable size */                        code2_UNAVAILABLE;
}                                                            code2_UNAVAILABLE;


typedef struct code_cache *Cache                             code2_UNAVAILABLE;
...
#endif
struct code_cache {
    unsigned int mask /* total = mask + 1 */                 code2_UNAVAILABLE;
    unsigned int occupied                                    code2_UNAVAILABLE;
    Method buckets[1]                                        code2_UNAVAILABLE;
};


typedef struct code_module *Module                           code2_UNAVAILABLE;

struct code_module {
    unsigned long version                                    code2_UNAVAILABLE;
    unsigned long size                                       code2_UNAVAILABLE;
    const char *name                                         code2_UNAVAILABLE;
    Symtab symtab                                            code2_UNAVAILABLE;
}                                                            code2_UNAVAILABLE;
...
CODE_EXPORT IMP class_lookupMethod(Class cls, SEL sel) 
    __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_0,__MAC_10_5, __IPHONE_2_0,__IPHONE_2_0);
CODE_EXPORT BOOL class_respondsToMethod(Class cls, SEL sel)
    __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_0,__MAC_10_5, __IPHONE_2_0,__IPHONE_2_0);
CODE_EXPORT void _code_flush_caches(Class cls) 
    __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_0,__MAC_10_5, __IPHONE_2_0,__IPHONE_2_0);

CODE_EXPORT id object_copyFromZone(id anObject, size_t nBytes, void *z) 
    __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_0,__MAC_10_5, __IPHONE_NA,__IPHONE_NA)
    code_ARC_UNAVAILABLE;
CODE_EXPORT id object_realloc(id anObject, size_t nBytes)    code2_UNAVAILABLE;
CODE_EXPORT id object_reallocFromZone(id anObject, size_t nBytes, void *z) code2_UNAVAILABLE;

#define OBSOLETE_code_GETCLASSES 1
CODE_EXPORT void *code_getClasses(void)                      code2_UNAVAILABLE;
CODE_EXPORT void code_addClass(Class myClass)                code2_UNAVAILABLE;
CODE_EXPORT void code_setClassHandler(int (*)(const char *)) code2_UNAVAILABLE;
CODE_EXPORT void code_setMultithreaded (BOOL flag)           code2_UNAVAILABLE;

CODE_EXPORT id class_createInstanceFromZone(Class, size_t idxIvars, void *z)  
    __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_0,__MAC_10_5, __IPHONE_NA,__IPHONE_NA)
    code_ARC_UNAVAILABLE;

CODE_EXPORT void class_addMethods(Class, struct code_method_list *) code2_UNAVAILABLE;
CODE_EXPORT void class_removeMethods(Class, struct code_method_list *) code2_UNAVAILABLE;
CODE_EXPORT void _code_resolve_categories_for_class(Class cls)  code2_UNAVAILABLE;

CODE_EXPORT Class class_poseAs(Class imposter, Class original) code2_UNAVAILABLE;

CODE_EXPORT unsigned int method_getSizeOfArguments(Method m) code2_UNAVAILABLE;
CODE_EXPORT unsigned method_getArgumentInfo(struct code_method *m, int arg, const char **type, int *offset) code2_UNAVAILABLE;

CODE_EXPORT Class code_getOrigClass(const char *name)        code2_UNAVAILABLE;
#define CODE_NEXT_METHOD_LIST 1
CODE_EXPORT struct code_method_list *class_nextMethodList(Class, void **) code2_UNAVAILABLE;
...
CODE_EXPORT id (*_alloc)(Class, size_t)                      code2_UNAVAILABLE;
CODE_EXPORT id (*_copy)(id, size_t)                          code2_UNAVAILABLE;
CODE_EXPORT id (*_realloc)(id, size_t)                       code2_UNAVAILABLE;
CODE_EXPORT id (*_dealloc)(id)                               code2_UNAVAILABLE;
CODE_EXPORT id (*_zoneAlloc)(Class, size_t, void *)          code2_UNAVAILABLE;
CODE_EXPORT id (*_zoneRealloc)(id, size_t, void *)           code2_UNAVAILABLE;
CODE_EXPORT id (*_zoneCopy)(id, size_t, void *)              code2_UNAVAILABLE;
CODE_EXPORT void (*_error)(id, const char *, va_list)        code2_UNAVAILABLE;
