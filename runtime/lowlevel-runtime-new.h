...
#ifndef RUNTIME_NEW_H
#define RUNTIME_NEW_H
...
// class has attribute(code_exception): code_EHTYPE_$_ThisClass is non-weak
#define RO_EXCEPTION          (1<<5)
// this bit is available for reassignment
// #define RO_REUSE_ME           (1<<6) 
// class compiled with -fcode-arc (automatic retain/release)
...
struct swift_class_t : code_class {
    uint32_t flags;
