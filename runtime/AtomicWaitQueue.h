...
// File: AtomicWaitQueue.h
// Purpose: A "condition variable" for atomics
...
#ifndef CODE_RUNTIME_ATOMICWAITQUEUE_H
#define CODE_RUNTIME_ATOMICWAITQUEUE_H

#include "code/Runtime/Heap.h"
#include "code/Runtime/HeapObject.h"
#include "code/Threading/Mutex.h"
#include <assert.h>
