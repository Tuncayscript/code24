...
namespace {
    ...
    static void addSanitizerPasses(ModulePassManager &MPM, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        // Coverage sanitizer
        ...
        auto MSanPass = [&](/*SanitizerMask Mask, */bool CompileKernel) LANGUAGE_NOTSAFEPOINT {
        ...
        auto ASanPass = [&](/*SanitizerMask Mask, */bool CompileKernel) LANGUAGE_NOTSAFEPOINT {
        //   if (LangOpts.Sanitize.has(Mask)) {
    ...
    static inline void addVerificationPasses(ModulePassManager &MPM, bool llvm_only) LANGUAGE_NOTSAFEPOINT {
        if (!llvm_only){
    ...
    auto basicSimplifyCFGOptions() LANGUAGE_NOTSAFEPOINT {
    ...
    auto aggressiveSimplifyCFGOptions() LANGUAGE_NOTSAFEPOINT {
        return SimplifyCFGOptions()
            .convertSwitchRangeToICmp(true)
            .convertSwitchToLookupTable(true)
            .forwardSwitchCondToPhi(true)
...
#pragma clang diagnostic ignored "-Wunused-function"
    ...
    template<typename PB> std::true_type hasInvokeCallbacks_helper(decltype(&PB::invokePipelineStartEPCallbacks)) LANGUAGE_NOTSAFEPOINT;
    std::false_type hasInvokeCallbacks_helper(...) LANGUAGE_NOTSAFEPOINT;
    ...
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokePipelineStartCallbacks(ModulePassManager &MPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
    ...
    template<typename PB_t>
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokePeepholeEPCallbacks(FunctionPassManager &FPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        static_assert(std::is_same<PassBuilder, PB_t>::value, "Expected PassBuilder as second argument!");
        if (!PB) return;
        PB->invokePeepholeEPCallbacks(FPM, O);
    }
    template<typename PB_t>
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokeEarlySimplificationCallbacks(ModulePassManager &MPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        static_assert(std::is_same<PassBuilder, PB_t>::value, "Expected PassBuilder as second argument!");
        if (!PB) return;
        PB->invokePipelineEarlySimplificationEPCallbacks(MPM, O);
    }
    template<typename PB_t>
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokeCGSCCCallbacks(CGSCCPassManager &CGPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        static_assert(std::is_same<PassBuilder, PB_t>::value, "Expected PassBuilder as second argument!");
        if (!PB) return;
        PB->invokeCGSCCOptimizerLateEPCallbacks(CGPM, O);
    }
    template<typename PB_t>
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokeOptimizerEarlyCallbacks(ModulePassManager &MPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        static_assert(std::is_same<PassBuilder, PB_t>::value, "Expected PassBuilder as second argument!");
        if (!PB) return;
        PB->invokeOptimizerEarlyEPCallbacks(MPM, O);
    }
    template<typename PB_t>
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokeLateLoopOptimizationCallbacks(LoopPassManager &LPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        static_assert(std::is_same<PassBuilder, PB_t>::value, "Expected PassBuilder as second argument!");
        if (!PB) return;
        PB->invokeLateLoopOptimizationsEPCallbacks(LPM, O);
    }
    template<typename PB_t>
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokeLoopOptimizerEndCallbacks(LoopPassManager &LPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        static_assert(std::is_same<PassBuilder, PB_t>::value, "Expected PassBuilder as second argument!");
        if (!PB) return;
        PB->invokeLoopOptimizerEndEPCallbacks(LPM, O);
    }
    template<typename PB_t>
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokeScalarOptimizerCallbacks(FunctionPassManager &FPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        static_assert(std::is_same<PassBuilder, PB_t>::value, "Expected PassBuilder as second argument!");
        if (!PB) return;
        PB->invokeScalarOptimizerLateEPCallbacks(FPM, O);
    }
    template<typename PB_t>
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokeVectorizerCallbacks(FunctionPassManager &FPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        static_assert(std::is_same<PassBuilder, PB_t>::value, "Expected PassBuilder as second argument!");
        if (!PB) return;
        PB->invokeVectorizerStartEPCallbacks(FPM, O);
    }
    template<typename PB_t>
    std::enable_if_t<decltype(hasInvokeCallbacks_helper<PB_t>(nullptr))::value, void> invokeOptimizerLastCallbacks(ModulePassManager &MPM, PB_t *PB, OptimizationLevel O) LANGUAGE_NOTSAFEPOINT {
        static_assert(std::is_same<PassBuilder, PB_t>::value, "Expected PassBuilder as second argument!");
        if (!PB) return;
...
static void buildEarlySimplificationPipeline(ModulePassManager &MPM, PassBuilder *PB, OptimizationLevel O, const OptimizationOptions &options) LANGUAGE_NOTSAFEPOINT {
...
static void buildEarlyOptimizerPipeline(ModulePassManager &MPM, PassBuilder *PB, OptimizationLevel O, const OptimizationOptions &options) LANGUAGE_NOTSAFEPOINT {
...
static void buildLoopOptimizerPipeline(FunctionPassManager &FPM, PassBuilder *PB, OptimizationLevel O, const OptimizationOptions &options) LANGUAGE_NOTSAFEPOINT {
...
static void buildScalarOptimizerPipeline(FunctionPassManager &FPM, PassBuilder *PB, OptimizationLevel O, const OptimizationOptions &options) LANGUAGE_NOTSAFEPOINT {
...
static void buildVectorPipeline(FunctionPassManager &FPM, PassBuilder *PB, OptimizationLevel O, const OptimizationOptions &options) LANGUAGE_NOTSAFEPOINT {
...
static void buildIntrinsicLoweringPipeline(ModulePassManager &MPM, PassBuilder *PB, OptimizationLevel O, const OptimizationOptions &options) LANGUAGE_NOTSAFEPOINT {
...
static void buildCleanupPipeline(ModulePassManager &MPM, PassBuilder *PB, OptimizationLevel O, const OptimizationOptions &options) LANGUAGE_NOTSAFEPOINT {
...
static void buildPipeline(ModulePassManager &MPM, PassBuilder *PB, OptimizationLevel O, const OptimizationOptions &options) LANGUAGE_NOTSAFEPOINT {
...
extern "C" LANGUAGE_DLLEXPORT_CODEGEN void language_build_newpm_pipeline_impl(void *MPM, void *PB, PipelineConfig* config) LANGUAGE_NOTSAFEPOINT
{
    OptimizationLevel O;
    switch (config->Size) {
        case 1:
...
namespace {
    ...
    void adjustPIC(PassInstrumentationCallbacks &PIC) LANGUAGE_NOTSAFEPOINT {
...
#undef CGSCC_ANALYSIS
    ...
    FunctionAnalysisManager createFAM(OptimizationLevel O, TargetMachine &TM) LANGUAGE_NOTSAFEPOINT {

        FunctionAnalysisManager FAM;
        // Register the AA manager first so that our version is the one used.
        FAM.registerPass([&] LANGUAGE_NOTSAFEPOINT {
            AAManager AA;
            if (O.getSpeedupLevel() >= 2) {
        ...
        FAM.registerPass([&] LANGUAGE_NOTSAFEPOINT { return llvm::TargetIRAnalysis(TM.getTargetIRAnalysis()); });
        FAM.registerPass([&] LANGUAGE_NOTSAFEPOINT { return llvm::TargetLibraryAnalysis(llvm::TargetLibraryInfoImpl(TM.getTargetTriple())); });
        return FAM;
    }

    ModulePassManager createMPM(PassBuilder &PB, OptimizationLevel O, OptimizationOptions options) LANGUAGE_NOTSAFEPOINT {
...
bool verifyLLVMIR(const Module &M) LANGUAGE_NOTSAFEPOINT {
    LANGUAGE_TIMING(VERIFY_IR, VERIFY_Module);
...
bool verifyLLVMIR(const Function &F) LANGUAGE_NOTSAFEPOINT {
    LANGUAGE_TIMING(VERIFY_IR, VERIFY_Function);
...
bool verifyLLVMIR(const Loop &L) LANGUAGE_NOTSAFEPOINT {
    LANGUAGE_TIMING(VERIFY_IR, VERIFY_Loop);
...
static void registerCallbacks(PassBuilder &PB) LANGUAGE_NOTSAFEPOINT {
...
#undef MODULE_PASS
            ...
            auto language_options = parseJuliaPipelineOptions(Name);
            if (language_options) {
                ModulePassManager pipeline;
                buildPipeline(pipeline, nullptr, language_options->first, language_options->second);
...
void language_register_passbuilder_callbacks_impl(void *PB) LANGUAGE_NOTSAFEPOINT {
    registerCallbacks(*static_cast<PassBuilder*>(PB));
}

extern "C" LANGUAGE_DLLEXPORT_CODEGEN
::llvm::PassPluginLibraryInfo llvmGetPassPluginInfo() LANGUAGE_NOTSAFEPOINT {
