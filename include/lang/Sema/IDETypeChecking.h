...
// File: IDETypeChecking.h 
// Purpose: Type-check entry points
...
#ifndef CODE_SEMA_IDETYPECHECKING_H
#define CODE_SEMA_IDETYPECHECKING_H

#include "code/AST/ASTNode.h"
#include "code/AST/Identifier.h"
#include "code/AST/TypeCheckRequests.h"
