...
#ifndef CODE_IDE_APIDIGESTERDATA_H
#define CODE_IDE_APIDIGESTERDATA_H

#include "code/Basic/LLVM.h"
#include "code/Basic/JSONSerialization.h"
...
#include "code/IDE/DigesterEnums.def"
};
...
#endif // CODE_IDE_APIDIGESTERDATA_H
