...
#ifndef CODE_CPP_INTEROP_CPP_REFACTORING_FOR_RANGE_H_
#define CODE_CPP_INTEROP_CPP_REFACTORING_FOR_RANGE_H_
...
#endif  // CODE_CPP_INTEROP_CPP_REFACTORING_FOR_RANGE_H_
