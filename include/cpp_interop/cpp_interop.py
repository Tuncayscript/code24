...
class _Workflow:
    ...
    def __init__(self) -> None:
        ...
        parser.add_argument(
            "dir",
            type=str,
            help="A directory containing C++ files to migrate to Code.",
        )
    ...
    def _cpp_refactoring(self) -> None:
        """Runs cpp_refactoring to migrate C++ files towards Code syntax."""
    ...
    def _rename_files(self) -> None:
        """Renames C++ files to the destination Code filenames."""
        api_renames = 0
        impl_renames = 0
        assert self._cpp_files is not None
