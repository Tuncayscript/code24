...
#ifndef CPP_REWRITER_H_
#define CPP_REWRITER_H_
...
#include "cpp_interop/output_segment.h"
...
namespace Code {
    ...
    // text of a Code source file which is a best approximation of the
    ...
    // on an AST, populating a `std::string` with the text of a Code source file
