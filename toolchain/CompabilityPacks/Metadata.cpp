...
CODE_RUNTIME_EXPORT CODE_CC(code)
const Metadata * const *
code_allocateMetadataPack(const Metadata * const *ptr, size_t count) {
...
code_allocateWitnessTablePack(const WitnessTable * const *ptr, size_t count) {
